...
static int RepCartoonCGOGenerate(RepCartoon* I, RenderInfo* info)
{
  ...
  float alpha =
      1.0F - SettingGet_f(G, I->cs->Setting.get(), I->obj->Setting.get(),
  ...
  has_cylinders_to_optimize =
      G->ShaderMgr->Get_CylinderShader(info->pass, 0) &&
  ...
  if (use_shaders) {
    if (hasAlpha && (SettingGetGlobal_i(G, cSetting_transparency_mode) != 3)) {
      // some transparency
      ...
      bool has_spheres_to_optimize =
          CGOHasSphereOperations(leftOverCGOBorrowed);
      if (has_spheres_to_optimize) {
        /* Optimize spheres and putting them into convertcgo as a shader CGO
         * operation */
      ...
      std::unique_ptr<CGO> leftOverCGOSimplified(
          CGOSimplify(leftOverCGOBorrowed));
    ...
    if (ok) {
      ...
      if (hasAlpha) {
        ...
        if (I->std) {
          I->std->render_alpha =
              1; // CGORenderGL should call CGOSetZVector/CGORenderGLAlpha only
        }
      } else {
        I->std = simplifiedCGO;
        CHECKOK(ok, I->std);
...
void RepCartoon::render(RenderInfo* info)
{
  ...
  if (G->HaveGUI && G->ValidContext) {
    ...
    if (I->std && CGOHasOperations(I->std)) {
      ...
      if (info->pick) {
        CGORenderPicking(I->std, info, &I->context, I->cs->Setting.get(),
            I->obj->Setting.get());
      } else {
        CGORender(I->std, nullptr, I->cs->Setting.get(), I->obj->Setting.get(),
            info, I);
      }
    }
  }
 ...
 */
static bool ring_connector_visible(PyMOLGlobals* G, const AtomInfoType* ai1,
    const AtomInfoType* ai2, bool sc_helper)
{
 ...
 */
static bool has_nuc_neighbor(const int* nuc_flag, const ObjectMolecule* obj,
    const int atm, const int max_depth, std::set<int>& seen)
{
...
/* atix must contain n_atom + 1 elements, with the first atom repeated at the
 * end */

static void do_ring(PyMOLGlobals* G, nuc_acid_data* ndata, int n_atom,
    int* atix, ObjectMolecule* obj, CoordSet* cs, float ring_width, CGO* cgo,
    int ring_color, float ladder_radius, int ladder_color, int ladder_mode,
    int sc_helper, float ring_alpha, float alpha, int* marked, float* moved,
    float ring_radius)
{
    ...
    for (i = 0; i <= n_atom; i++) {
      ...
      if (a >= 0) {
        ...
        if (ai->visRep & cRepCartoonBit) {
          ...
          AtomSettingGetIfDefined(
              G, ai, cSetting_cartoon_ring_mode, &ring_mode);
          AtomSettingGetIfDefined(
              G, ai, cSetting_cartoon_ring_color, &ring_color);
          AtomSettingGetIfDefined(
              G, ai, cSetting_cartoon_ring_radius, &ring_radius);
          AtomSettingGetIfDefined(
              G, ai, cSetting_cartoon_ring_width, &ring_width);
          AtomSettingGetIfDefined(
              G, ai, cSetting_cartoon_ladder_mode, &ladder_mode);
          AtomSettingGetIfDefined(
              G, ai, cSetting_cartoon_ladder_color, &ladder_color);
          AtomSettingGetIfDefined(
  ...
  if (n_atom && have_all && (!all_marked)) {
          ...
          if ((ai->protons == cAN_C) && (!marked[a1]) &&
            ...
            while ((mem1 = neighbor[nbr[0]]) >= 0) {
                      ...
                      if ((mem3 != mem1) && (mem3 != mem0)) {
                        ...
                        if (atomInfo[mem3].protons == cAN_N) {
                          ...
                          if (ring_mode) {
                            ...
                            if ((!marked[mem3]) &&
                                (WordMatchExact(
                                     G, "N1", LexStr(G, ai2->name), 1) ||
                                    WordMatchExact(
                                        G, "N9", LexStr(G, ai2->name), 1))) {
                              base_at = mem3;
                              if (ring_mode != 3) {
              ...
              nbr[0] += 2;
                 ...
                 (n_atom == 6)) { /* going from the base to the sugar */
                                    ...
                                    if ((mem6 != mem4) && (mem6 != mem3) &&
                                      ...
                                      while ((mem7 = neighbor[nbr[6]]) >= 0) {
                                        ...
                                        if ((mem7 != mem5) && (mem7 != mem4) &&
                                            ...
                                            (ai2->protons == cAN_C) &&
                                            (marked[mem7])) {
                                          if (WordMatchExact(G, NUCLEIC_NORMAL1,
                                                  LexStr(G, ai2->name), 1) ||
                    ...
                    while ((mem3 = neighbor[nbr[2]]) >= 0) {
                      if ((mem3 != mem1) && (mem3 != mem0) && (marked[mem3]) &&
                        ...
                        if (WordMatchExact(G, "C5", LexStr(G, ai->name), 1) &&
                            WordMatchExact(
                                G, "C6", LexStr(G, atomInfo[mem1].name), 1)) {
                          c5_linked = mem3;
                          c5 = mem0;
                        }
                      }
                  ...
                  if ((mem2 != mem0) && (marked[mem2]) &&
                    ...
                    while ((mem3 = neighbor[nbr[2]]) >= 0) {
                      if ((mem3 != mem1) && (mem3 != mem0) && (marked[mem3]) &&
                        ...
                        /* cyclic C */
                        if (WordMatchExact(
                                G, "C5", LexStr(G, atomInfo[mem3].name), 1) &&
                            WordMatchExact(
                                G, "C6", LexStr(G, atomInfo[mem2].name), 1)) {
                          c5 = mem0;
                          c5_linked = mem3;
                        }
                        ...
                        if (WordMatchExact(G, "C1", LexStr(G, ai->name), 1) &&
                            WordMatchExact(
                                G, "CA", LexStr(G, atomInfo[mem3].name), 1)) {
                          c1 = mem0;
                          c1_linked = mem3;
                        }
                      }
                      ...
                      if ((mem3 != mem1) && (mem3 != mem0) && (!marked[mem3]) &&
                        ...
                        while ((mem4 = neighbor[nbr[3]]) >= 0) {
                          if ((mem4 != mem2) && (mem3 != mem1) &&
                            ...
                            /* exocyclic */
                            if (WordMatchExact(
                                    G, "C1", LexStr(G, ai->name), 1) &&
                                WordMatchExact(G, "CA",
                                    LexStr(G, atomInfo[mem4].name), 1)) {
                              c1 = mem0;
                              c1_linked = mem4;
                            }
                          }
              ...
              if ((g1 >= 0) && (g2 >= 0)) {
                ...
                if (ring_connector_visible(G, g1_ai, g2_ai, sc_helper)) {
                  ...
                  if ((ring_mode == 0) || (ring_mode == 4) ||
                    ...
                    /* ring center */
                    int i;
                    /* compute average coordinate and mark atoms so that ring is
                     * only drawn once */
                    zero3f(avg);
                    for (i = 0; i < n_atom; i++) {
                      add3f(avg, v_i[i], avg);
...

                  {
                    ...
                    CGOPickColor(cgo, g1,
                        g1_ai->masked ? cPickableNoPick : cPickableAtom);
                    Pickable pickcolor2 = {static_cast<unsigned int>(g2),
                        g2_ai->masked ? cPickableNoPick : cPickableAtom};
                    float axis[3];
                    subtract3f(g2p, g1p, axis);
                    CGOColorv(cgo, color1);
                    float ladder_alpha =
                        1.0f - AtomSettingGetWD(G, ai_i[i],
                                   cSetting_cartoon_transparency, 1.0f - alpha);
                  ...
                  if ((sug >= 0) && (bas >= 0)) {
                    {
                      ...
                      CGOPickColor(cgo, sugar_at,
                          sug_ai->masked ? cPickableNoPick : cPickableAtom);
                      Pickable pickcolor2 = {static_cast<unsigned int>(base_at),
                          bas_ai->masked ? cPickableNoPick : cPickableAtom};
                      float axis[3];
                      ...
                      float ladder_alpha =
                          1.0f - AtomSettingGetWD(G, ai_i[i],
                                     cSetting_cartoon_transparency,
                                     1.0f - alpha);
                      cgo->add<cgo::draw::shadercylinder2ndcolor>(cgo,
                          cs->coordPtr(sug), axis, ladder_radius, 0x1f, color2,
                          &pickcolor2, ladder_alpha);
                    }
                  }
                }
              }
            ...
            if (ring_connector_visible(G, bas_ai, sug_ai, sc_helper)) {
              ...
              if ((sug >= 0) && (bas >= 0)) {
                ...
                }
                {
                  ...
                  CGOColorv(cgo, color1);
                  float ladder_alpha =
                      1.0f - AtomSettingGetWD(G, sug_ai,
                                 cSetting_cartoon_transparency, 1.0f - alpha);
                  cgo->add<cgo::draw::shadercylinder2ndcolor>(cgo, v_outer,
                      axis, ladder_radius, 0x1f, color2, &pickcolor2,
                      ladder_alpha);
                }
              }
            }
    ...
    if (n_atom) { /* store center of ring */
      ...
      /* compute average coordinate and mark atoms so that ring is only drawn
       * once */
      zero3f(avg);
      zero3f(avg_col);
      ...
      if ((nf || (!ladder_mode) || (finder >= 3)) && ring_mode &&
        ...
        auto atom_alpha =
            1.0f - AtomSettingGetWD(G, ai_i[i], cSetting_cartoon_transparency,
                       1.0f - ring_alpha);
        ...
        if ((ring_mode == 4) || (ring_mode == 5)) { /* spherical ring  */
          ...
          if (n_atom) {
            ...
            CGOPickColor(cgo, atix[0],
                ai_i[0]->masked ? cPickableNoPick : cPickableAtom);
...

          {
            ...
            for (i = 0; i < n_atom; i++) {
              ...
              if (ring_color < 0)
                CGOColorv(cgo, color);
              CGOPickColor(cgo, atix[i],
                  ai_i[i]->masked ? cPickableNoPick : cPickableAtom);
              CGOVertexv(cgo, ct);
              ...
              CGOPickColor(cgo, atix[ii],
                  ai_i[ii]->masked ? cPickableNoPick : cPickableAtom);
...

            {
              ...
              for (i = 0; i < n_atom; i++) {
                ii = i + 1;
                {
                  ...
                  CGOPickColor(cgo, atix[i],
                      ai_i[i]->masked ? cPickableNoPick : cPickableAtom);
                  Pickable pickcolor2 = {static_cast<unsigned int>(atix[ii]),
                      ai_i[ii]->masked ? cPickableNoPick : cPickableAtom};
                  float axis[3];
                  ...
                  cgo->add<cgo::draw::shadercylinder2ndcolor>(cgo, v_i[i], axis,
                      ring_width_for_mode, 0x1f, color2, &pickcolor2,
                      ladder_alpha);
                }
              }
            }
...
static void nuc_acid(PyMOLGlobals* G, nuc_acid_data* ndata, int a, int a1,
    const AtomInfoType* ai, const CoordSet* cs, const ObjectMolecule* obj,
    int set_flags)
{
  int a3, a4, st, nd;
  const float *v_o, *v_c;
  ...
  *(ndata->cc++) = cur_car;
  ...
  if (ndata->a2 >= 0) {
    if (set_flags) {
      if ((obj->AtomInfo[ndata->a2].protons == cAN_P) &&
          (!nuc_flag[ndata->a2])) {
        int* nf = nullptr;
        AtomInfoBracketResidueFast(
            G, obj->AtomInfo, obj->NAtom, ndata->a2, &st, &nd);
    ...
    } else if ((ndata->na_mode >= 2) &&
               (!nuc_flag[ndata->a2])) { /* just a single nucleotide -- skip */
...

  {
    ...
    for (a3 = st; a3 <= nd; a3++) {
      if (nf)
        *(nf++) =
            true; /* mark this residue as being part of a nucleic acid chain */
      a4 = cs->atmToIdx(a3);
      if (a4 >= 0) {
        if (ndata->na_mode == 1) {
          if (WordMatchExact(
                  G, NUCLEIC_NORMAL1, LexStr(G, obj->AtomInfo[a3].name), 1) ||
              WordMatchExact(
                  G, NUCLEIC_NORMAL2, LexStr(G, obj->AtomInfo[a3].name), 1)) {
            v_c = cs->coordPtr(a4);
          }
        } else if (a3 == a1) {
          v_c = cs->coordPtr(a4);
        ...
        if (WordMatchExact(
                G, NUCLEIC_NORMAL0, LexStr(G, obj->AtomInfo[a3].name), 1)) {
          v_o = cs->coordPtr(a4);
        }
      }
    }
...
static void GenerateRepCartoonDrawDebugLineAlongPath(
    CGO* cgo, int nAt, float* pv)
{
  float *v, *v1, *v2, *v3, *v4;
  float t0[3], t1[3];
  int a;
...
static int GenerateRepCartoonDrawDebugNormals(CGO* cgo, CExtrude* ex, int n_p)
{
  int b, ok;
  float *v, *vn;
  float t0[3];
...
static int GenerateRepCartoonDrawDebugOrient(
    CGO* cgo, int nAt, float* pv, float* pvo, float* tv)
{
  int ok, a;
  float *v1, *v2, *v3;
  float t0[3];
...
static int GenerateRepCartoonProcessCylindricalHelices(PyMOLGlobals* G,
    ObjectMolecule* obj, CoordSet* cs, CGO* cgo, CExtrude* ex, int nAt,
    int* seg, float* pv, float* tv, float* pvo, const CCInOut* cc, int* at,
    float* dl, int cartoon_color, int discrete_colors, float loop_radius,
    const float objAlpha)
{
  int ok = true;
  int n_p, n_pm1, n_pm2;
  const float* v0;
  ...
  float* valpha;
  float* vc = nullptr;
  int atom_index1, atom_index2, *s, *atp, a, cur_car;
  unsigned* vi;
  ...
  while (contFlag) {
    ...
    if (!extrudeFlag) {
      if ((a < (nAt - 1)) &&
          (*s == *(s + 1))) { /* working in the same segment... */
        ...
        float alpha1 =
            1.0f - AtomSettingGetWD(
                       G, ai1, cSetting_cartoon_transparency, 1.0f - objAlpha);
        float alpha2 =
            1.0f - AtomSettingGetWD(
                       G, ai2, cSetting_cartoon_transparency, 1.0f - objAlpha);
      ...
      if (cur_car == cCartoon_skip_helix) {
        ...
        copy3f(v1,
            v); /* just store coordinates until we have a complete cylinder */
        v += 3;
        n_p++;
      }
      v1 += 3;
        ...
        if (uniform_color && !hasAtomLevelTrans) {
          ...
          for (b = 0; ok && b < n_pm1; b++) {
            ...
            if (hasAtomLevelTrans) {
              cgo->add<cgo::draw::custom_cylinder_alpha>(t1, t2, helix_radius,
                  ex->c + (b * 3), ex->c + (b + 1) * 3, ex->alpha[b],
                  ex->alpha[b + 1], (float) (b ? cCylCap::None : cCylCap::Flat),
                  (float) (b == n_pm2 ? cCylCap::Flat : cCylCap::None));
            } else {
              cgo->add<cgo::draw::custom_cylinder>(t1, t2, helix_radius,
                  ex->c + (b * 3), ex->c + (b + 1) * 3,
                  (float) (b ? cCylCap::None : cCylCap::Flat),
                  (float) (b == n_pm2 ? cCylCap::Flat : cCylCap::None));
            }
          }
        }
...
static int GenerateRepCartoonDrawRings(PyMOLGlobals* G, nuc_acid_data* ndata,
    ObjectMolecule* obj, CoordSet* cs, CGO* cgo, float ring_width,
    int cartoon_color, float alpha)
{
  int ring_i;
  int mem[8];
  int nbr[7];
  ...
  float ring_alpha;
  ring_alpha = SettingGet_f(G, cs->Setting.get(), obj->Setting.get(),
      cSetting_cartoon_ring_transparency);
  if (ring_alpha < 0.0F)
    ring_alpha = alpha;
  else
    ring_alpha = 1.0F - ring_alpha;
  cartoon_side_chain_helper = SettingGet_b(G, cs->Setting.get(),
      obj->Setting.get(), cSetting_cartoon_side_chain_helper);
  ladder_mode = SettingGet_i(
      G, cs->Setting.get(), obj->Setting.get(), cSetting_cartoon_ladder_mode);
  ladder_radius = SettingGet_f(
      G, cs->Setting.get(), obj->Setting.get(), cSetting_cartoon_ladder_radius);
  ladder_color = SettingGet_color(
      G, cs->Setting.get(), obj->Setting.get(), cSetting_cartoon_ladder_color);
  ring_radius = SettingGet_f(
      G, cs->Setting.get(), obj->Setting.get(), cSetting_cartoon_ring_radius);
  if (ladder_color == -1)
    ladder_color = cartoon_color;
  ring_color = SettingGet_color(
      G, cs->Setting.get(), obj->Setting.get(), cSetting_cartoon_ring_color);
  if (ring_color == -1)
                  ...
                  while (((mem[5] = neighbor[nbr[4]]) >= 0) &&
                    ...
                    if ((mem[5] != mem[3]) && (mem[5] != mem[2]) &&
                      ...
                      if (mem[5] == mem[0]) { /* five-cycle */
                        ...
                        do_ring(G, ndata, 5, mem, obj, cs, ring_width, cgo,
                            ring_color, ladder_radius, ladder_color,
                            ladder_mode, cartoon_side_chain_helper, ring_alpha,
                            alpha, marked, moved, ring_radius);
                      }
                      ...
                      while (((mem[6] = neighbor[nbr[5]]) >= 0) &&
                        ...
                        if ((mem[6] != mem[4]) && (mem[6] != mem[3]) &&
                          ...
                          if (mem[6] == mem[0]) { /* six-cycle */
                            ...
                            do_ring(G, ndata, 6, mem, obj, cs, ring_width, cgo,
                                ring_color, ladder_radius, ladder_color,
                                ladder_mode, cartoon_side_chain_helper,
                          ...
                          while (((mem[7] = neighbor[nbr[6]]) >= 0) &&
                            ...
                            if ((mem[7] != mem[5]) && (mem[7] != mem[4]) &&
                                ...
                                (mem[7] != mem[1])) {
                              if (mem[7] == mem[0]) {
                                do_ring(G, ndata, 7, mem, obj, cs, ring_width,
                                    cgo, ring_color, ladder_radius,
                                    ladder_color, ladder_mode,
                                    cartoon_side_chain_helper, ring_alpha,
                                    alpha, marked, moved, ring_radius);
                              }
                            }
                            nbr[6] += 2;
...
/* CheckExtrudeContigFlags: compares current cartoon type and next to figure out
   whether to extrude, truncate, and/or whether its contiguous */
static int CheckExtrudeContigFlags(int nAt, int n_p, int a,
    int* cur_car, // in-out
    const CCInOut* cc, const int* segptr, int* /* contigFlag */,
    int* extrudeFlag)
{
  int truncate = false;
...
static void ComputeCartoonAtomColors(PyMOLGlobals* G, ObjectMolecule* obj,
    CoordSet* cs, int* nuc_flag, int atom_index1, int atom_index2, int* c1a,
    int* c2a, int* atp, const CCInOut* cc, int cur_car, int cartoon_color,
    float& alpha1, float& alpha2, int nucleic_color, int discrete_colors,
    int n_p, int contigFlag)
{
  ...
  alpha1 = 1.0f - AtomSettingGetWD(
                      G, ai1, cSetting_cartoon_transparency, 1.0f - alpha1);
  alpha2 = 1.0f - AtomSettingGetWD(
                      G, ai2, cSetting_cartoon_transparency, 1.0f - alpha2);
...
static void CartoonGenerateSample(PyMOLGlobals* G, int sampling, int* n_p,
    float dev, float* vo, float* v1, float* v2, int c1, int c2, float alpha1,
    float alpha2, int atom_index1, int atom_index2, float power_a,
    float power_b, float** vc_p, float** valpha_p, unsigned int** vi_p,
    float** v_p, float** vn_p)
{
  ...
  for (b = 0; b < sampling; b++) { /* needs optimization */
    if (*n_p == 0) {
      ...
      f0 = smooth(
          f0, power_a); /* bias sampling towards the center of the curve */
    ...
    f0 =
        smooth(f0, power_a); /* bias sampling towards the center of the curve */
...
static void CartoonGenerateRefine(int refine, int sampling, float* v, float* vn,
    float* vo, float* sampling_tmp)
{
  int b, c;
  float t0[3], t1[3];
  float *p0, *p1, *p2, *p3;
...
static int CartoonExtrudeTube(short use_cylinders_for_strands, CExtrude* ex,
    CGO* cgo, float tube_radius, int tube_quality, cCylCap tube_cap)
{
  int ok = true;
  if (use_cylinders_for_strands) {
    ...
    if (ok)
      ok &= ExtrudeCGOSurfaceTube(
          ex, cgo, tube_cap, nullptr, use_cylinders_for_strands);
  }
  return ok;
}

static int CartoonExtrudePutty(PyMOLGlobals* G, ObjectMolecule* obj,
    CoordSet* cs, CGO* cgo, CExtrude* ex, int putty_quality, float putty_radius,
    float* putty_vals, int sampling)
{
  int ok;
...
static int CartoonExtrudeCircle(CExtrude* ex, CGO* cgo,
    short use_cylinders_for_strands, int loop_quality, float loop_radius,
    cCylCap loop_cap, int dash = 0)
{
  int ok;
  ...
  if (ok)
    ok &= ExtrudeCGOSurfaceTube(
        ex, cgo, loop_cap, nullptr, use_cylinders_for_strands, dash);
  return ok;
}
...
static int CartoonExtrudeRect(PyMOLGlobals* G, CExtrude* ex, CGO* cgo,
    float width, float length, int highlight_color)
{
  int ok;
  if (highlight_color < 0) {
    ...
    if (ok) {
      ...
      if (ok)
        ExtrudeBuildNormals2f(ex);
      if (ok)
        ok &= ExtrudeCGOSurfacePolygon(
            ex, cgo, cCylCap::Flat, ColorGet(G, highlight_color));
    }
  }
  return ok;
}

static int CartoonExtrudeOval(PyMOLGlobals* G, CExtrude* ex, CGO* cgo,
    short use_cylinders_for_strands, int oval_quality, float oval_width,
    float oval_length, int highlight_color)
{
  int ok;
  ...
  if (ok) {
    if (highlight_color < 0)
      ok &= ExtrudeCGOSurfaceTube(
          ex, cgo, cCylCap::Flat, nullptr, use_cylinders_for_strands);
    else
      ok &= ExtrudeCGOSurfaceTube(ex, cgo, cCylCap::Flat,
          ColorGet(G, highlight_color), use_cylinders_for_strands);
  }
  return ok;
}

static int CartoonExtrudeArrow(PyMOLGlobals* G, CExtrude* ex, CGO* cgo,
    int sampling, float width, float length, int highlight_color)
{
  int ok;
  ok = ExtrudeRectangle(
      ex, width, length, 0); // ex->Ns is always 8 for ExtrudeCGOSurfaceStrand
  if (ok)
    ExtrudeBuildNormals2f(ex);
  if (ok) {
    if (highlight_color < 0)
...
static int CartoonExtrudeDumbbell(PyMOLGlobals* G, CExtrude* ex, CGO* cgo,
    int sampling, float dumbbell_width, float dumbbell_length,
    int highlight_color, int loop_quality, float dumbbell_radius,
    short use_cylinders_for_strands)
{
  int ok;
  ...
  if (highlight_color < 0) {
    ...
    if (ok)
      ExtrudeBuildNormals2f(ex);
    if (ok)
      ok &= ExtrudeCGOSurfacePolygonTaper(
          ex, cgo, sampling, ColorGet(G, highlight_color));
  }
  /*
  ...
  if (ok)
    ok &= ExtrudeCGOSurfaceTube(
        ex1, cgo, cCylCap::Flat, nullptr, use_cylinders_for_strands);
  if (ok) {
    ExtrudeFree(ex1);
    ex1 = ExtrudeCopyPointsNormalsColors(ex);
    CHECKOK(ok, ex1);
 ...
 */
static int GetCartoonQuality(
    CoordSet* cs, int setting, int v1, int v2, int v3, int v4, int min_ = 3)
{
  int quality = SettingGet<int>(
      cs->G, cs->Setting.get(), cs->Obj->Setting.get(), setting);

  if (quality == -1) {
    int natom = cs->NIndex;
    quality = (natom < 100000)   ? v1
              : (natom < 500000) ? v2
              : (natom < 999999) ? v3
                                 : v4;
...
static CGO* GenerateRepCartoonCGO(CoordSet* cs, ObjectMolecule* obj,
    nuc_acid_data* ndata, short use_cylinders_for_strands, float* pv, int nAt,
    float* tv, float* pvo, float* dl, const CCInOut* car, int* seg, int* at,
    int* nuc_flag, float* putty_vals, float alpha)
{
  PyMOLGlobals* G = cs->G;
  int ok = true;
  CGO* cgo;
  ...
  cartoon_color = SettingGet_color(
      G, cs->Setting.get(), obj->Setting.get(), cSetting_cartoon_color);
  ring_width = SettingGet_f(
      G, cs->Setting.get(), obj->Setting.get(), cSetting_cartoon_ring_width);
  if (ring_width < 0.0F) {
    ring_width = fabs(SettingGet_f(G, cs->Setting.get(), obj->Setting.get(),
                     cSetting_stick_radius)) *
                 0.5F;
  }
  length = SettingGet_f(
      G, cs->Setting.get(), obj->Setting.get(), cSetting_cartoon_rect_length);
  width = SettingGet_f(
      G, cs->Setting.get(), obj->Setting.get(), cSetting_cartoon_rect_width);
  oval_length = SettingGet_f(
      G, cs->Setting.get(), obj->Setting.get(), cSetting_cartoon_oval_length);
  dumbbell_length = SettingGet_f(G, cs->Setting.get(), obj->Setting.get(),
      cSetting_cartoon_dumbbell_length);
  oval_width = SettingGet_f(
      G, cs->Setting.get(), obj->Setting.get(), cSetting_cartoon_oval_width);
  dumbbell_width = SettingGet_f(G, cs->Setting.get(), obj->Setting.get(),
      cSetting_cartoon_dumbbell_width);
  dumbbell_radius = SettingGet_f(G, cs->Setting.get(), obj->Setting.get(),
      cSetting_cartoon_dumbbell_radius);
  if (dumbbell_radius < 0.01F)
    dumbbell_radius = 0.01F;

  auto tube_cap = static_cast<cCylCap>(SettingGet<int>(
      G, cs->Setting.get(), obj->Setting.get(), cSetting_cartoon_tube_cap));
  auto loop_cap = static_cast<cCylCap>(SettingGet<int>(
      G, cs->Setting.get(), obj->Setting.get(), cSetting_cartoon_loop_cap));

  tube_radius = SettingGet_f(
      G, cs->Setting.get(), obj->Setting.get(), cSetting_cartoon_tube_radius);
  if (tube_radius < 0.01F)
    tube_radius = 0.01F;
  putty_radius = SettingGet_f(
      G, cs->Setting.get(), obj->Setting.get(), cSetting_cartoon_putty_radius);
  /* WLD removed: if(putty_radius<0.01F) putty_radius=0.01F; --
     should not constrain what is effectively a scale factor */

  tube_quality =
      GetCartoonQuality(cs, cSetting_cartoon_tube_quality, 9, 7, 6, 5);
  oval_quality =
      GetCartoonQuality(cs, cSetting_cartoon_oval_quality, 10, 8, 7, 6);
  putty_quality =
      GetCartoonQuality(cs, cSetting_cartoon_putty_quality, 11, 9, 7, 5);
  loop_quality =
      GetCartoonQuality(cs, cSetting_cartoon_loop_quality, 6, 6, 5, 4);
  sampling = GetCartoonQuality(cs, cSetting_cartoon_sampling, 7, 5, 3, 2, 1);

  PRINTFB(G, FB_RepCartoon, FB_Blather)
  " RepCartoon: Use settings tube_quality=%d oval_quality=%d putty_quality=%d "
  "loop_quality=%d sampling=%d\n",
      tube_quality, oval_quality, putty_quality, loop_quality,
      sampling ENDFB(G);
  ...
  if (SettingGetGlobal_i(G, cSetting_ray_trace_mode) > 0)
    if (loop_quality < 12)
      loop_quality *= 2;
  refine = SettingGet_i(
      G, cs->Setting.get(), obj->Setting.get(), cSetting_cartoon_refine);
  power_a = SettingGet_f(
      G, cs->Setting.get(), obj->Setting.get(), cSetting_cartoon_power);
  power_b = SettingGet_f(
      G, cs->Setting.get(), obj->Setting.get(), cSetting_cartoon_power_b);
  throw_ = SettingGet_f(
      G, cs->Setting.get(), obj->Setting.get(), cSetting_cartoon_throw);
  loop_radius = SettingGet_f(
      G, cs->Setting.get(), obj->Setting.get(), cSetting_cartoon_loop_radius);
  if (loop_radius < 0.01F)
    loop_radius = 0.01F;
  discrete_colors = SettingGet_i(G, cs->Setting.get(), obj->Setting.get(),
      cSetting_cartoon_discrete_colors);
  nucleic_color = SettingGet_color(G, cs->Setting.get(), obj->Setting.get(),
      cSetting_cartoon_nucleic_acid_color);
  if (nucleic_color == -1)
    nucleic_color = cartoon_color;
  highlight_color = SettingGet_color(G, cs->Setting.get(), obj->Setting.get(),
      cSetting_cartoon_highlight_color);

  cylindrical_helices = SettingGet_i(G, cs->Setting.get(), obj->Setting.get(),
      cSetting_cartoon_cylindrical_helices);
  int const sampling_cylindrical_helices = sampling / 8 + 1;

  sampling_tmp = pymol::malloc<float>(sampling * 3);
  cartoon_debug = SettingGet_i(
      G, cs->Setting.get(), obj->Setting.get(), cSetting_cartoon_debug);
  ...
  if (ok && (nAt > 1) &&
      cylindrical_helices == CARTOON_CYLINDRICAL_HELICES_STRAIGHT) {
    ok = GenerateRepCartoonProcessCylindricalHelices(G, obj, cs, cgo, ex, nAt,
        seg, pv, tv, pvo, car, at, dl, cartoon_color, discrete_colors,
        loop_radius, alpha);
  }
  if (ok && nAt > 1) {
    EXTRUDE_TRUNCATE();
    ...
    const auto helix_radius = SettingGet<float>(G, cs->Setting.get(),
        obj->Setting.get(), cSetting_cartoon_helix_radius);

    while (contFlag) {
      if (CheckExtrudeContigFlags(
              nAt, n_p, a, &cur_car, cc, segptr, &contigFlag, &extrudeFlag)) {
        EXTRUDE_TRUNCATE();
      }

      if (ok && !extrudeFlag) {
        if ((a < (nAt - 1)) &&
            (*segptr == *(segptr + 1))) { /* working in the same segment... */
          AtomInfoType *ai1, *ai2;
          atom_index1 = cs->IdxToAtm[*atp];
          atom_index2 = cs->IdxToAtm[*(atp + 1)];
          ai1 = obj->AtomInfo + atom_index1;
          ...
          ComputeCartoonAtomColors(G, obj, cs, nuc_flag, atom_index1,
              atom_index2, &c1, &c2, atp, cc, cur_car, cartoon_color, alpha1,
              alpha2, nucleic_color, discrete_colors, n_p, contigFlag);
          dev = throw_ * (*d);
      ...
      if (ok && extrudeFlag) {
        ...
        if (ok && (cur_car != cCartoon_skip) &&
          ...
          if (ok) {
            ...
            switch (cur_car) {
            case cCartoon_tube:
              ok = CartoonExtrudeTube(use_cylinders_for_strands, ex, cgo,
                  tube_radius, tube_quality, tube_cap);
              break;
            case cCartoon_putty:
              ok = CartoonExtrudePutty(G, obj, cs, cgo, ex, putty_quality,
                  putty_radius, putty_vals, sampling);
              if (!ok)
                contFlag = false;
              break;
            case cCartoon_loop:
              ok = CartoonExtrudeCircle(ex, cgo, use_cylinders_for_strands,
                  loop_quality, loop_radius, loop_cap);
              break;
            case cCartoon_dash:
              ok = CartoonExtrudeCircle(ex, cgo, use_cylinders_for_strands,
                  loop_quality, loop_radius, loop_cap, 2);
              break;
            case cCartoon_rect:
              ok = CartoonExtrudeRect(
                  G, ex, cgo, width, length, highlight_color);
              break;
            case cCartoon_oval:
              ok = CartoonExtrudeOval(G, ex, cgo, use_cylinders_for_strands,
                  oval_quality, oval_width, oval_length, highlight_color);
              break;
            case cCartoon_arrow:
              ok = CartoonExtrudeArrow(
                  G, ex, cgo, sampling, width, length, highlight_color);
              break;
            case cCartoon_dumbbell:
              ok = CartoonExtrudeDumbbell(G, ex, cgo, sampling, dumbbell_width,
                  dumbbell_length, highlight_color, loop_quality,
                  dumbbell_radius, use_cylinders_for_strands);
              break;
  ...
  if (ok && ndata->ring_anchor && ndata->n_ring) {
    ok = GenerateRepCartoonDrawRings(
        G, ndata, obj, cs, cgo, ring_width, cartoon_color, alpha);
  }
  if (ok)
    CGOStop(cgo);
 ...
 * - rings
 */
static void RepCartoonGeneratePASS1(PyMOLGlobals* G, RepCartoon* I,
    ObjectMolecule* obj, CoordSet* cs, nuc_acid_data* ndata)
{
  int st, nd;
  int a, a1, a3, a4 = 0;
  char* lv = I->LastVisib;
  ...
  // settings
  fancy_sheets = SettingGet_i(
      G, cs->Setting.get(), obj->Setting.get(), cSetting_cartoon_fancy_sheets);
  fancy_helices = SettingGet_i(
      G, cs->Setting.get(), obj->Setting.get(), cSetting_cartoon_fancy_helices);
  cylindrical_helices = SettingGet_i(G, cs->Setting.get(), obj->Setting.get(),
      cSetting_cartoon_cylindrical_helices);
  cartoon_side_chain_helper = SettingGet_b(G, cs->Setting.get(),
      obj->Setting.get(), cSetting_cartoon_side_chain_helper);
  int trace_ostate = SettingGet_i(
      G, cs->Setting.get(), obj->Setting.get(), cSetting_cartoon_trace_atoms);
  trace_mode = SettingGet_i(
      G, cs->Setting.get(), obj->Setting.get(), cSetting_trace_atoms_mode);
  auto gap_cutoff = SettingGet_i(
      G, cs->Setting.get(), obj->Setting.get(), cSetting_cartoon_gap_cutoff);
   ...
   * representations. For now, use this flag to track hidden (but valid atoms)
   * cartoons, which should be skipped and not dashed. Removed residues should
   * be dashed. See PYMOL-3168
   */
  ...
  for (CoordSetAtomIterator iter(cs); iter.next();) {
    ...
    // rings
    if (ndata->ring_anchor && ai->protons != cAN_H &&
    ...
    if (trace ||
        (ai->protons == cAN_C && WordMatchExact(G, "CA", ai_name, true) &&
            !AtomInfoSameResidueP(G, last_ai, ai))) {

      PRINTFD(G, FB_RepCartoon)
      " RepCartoon: found CA in %d%c; a2 %d\n", ai->resv, ai->getInscode(true),
          ndata->a2 ENDFD;
      ...
      if (is_gap) {
        ...
        if (delta < 1 || delta > gap_cutoff ||
            !AtomInfoSameChainP(G, ai, last_ai)) {
          ndata->a2 = -1;
        } else {
      ...
      case 'h':
        if (cur_car == cCartoon_auto) {
          if (cylindrical_helices == CARTOON_CYLINDRICAL_HELICES_STRAIGHT) {
            cur_car = cCartoon_skip_helix;
          } else if (cylindrical_helices ==
                     CARTOON_CYLINDRICAL_HELICES_CURVED) {
      ...
      *(ndata->iptr++) = a;
    ...
    } else if (!AtomInfoSameResidueP(G, last_ai, ai) &&
               (ndata->na_mode != 1 ?
                                    // P atom
                       (ai->protons == cAN_P &&
                           WordMatchExact(G, "P", ai_name, true))
                                    :
                                    // C3* C3' atom
                       (ai->protons == cAN_C &&
                           (WordMatchExact(G, NUCLEIC_NORMAL1, ai_name, 1) ||
                               WordMatchExact(
                                   G, NUCLEIC_NORMAL2, ai_name, 1))))) {
      ...
      /*  5' cap */
      if (leading_O5p.active() && ndata->a2 < 0 &&
      ...
      nuc_acid(G, ndata, a, a1, ai, cs, obj, true);
        ...
        // P -> O3* bond
        AtomInfoSameResidueP(G, last_ai, ai) && ndata->a2 >= 0 && last_ai &&
        cAN_P == last_ai->protons && cAN_O == ai->protons &&
      ...
      trailing_O3p.set(a, a1, ai);
        ...
        // O5* atom
        ai->protons == cAN_O && leading_O5p.enabled &&
...
static void RepCartoonComputePuttyValues(ObjectMolecule* obj, float* putty_vals)
{
...
static void RepCartoonComputeDifferencesAndNormals(PyMOLGlobals* G, int nAt,
    int* seg, float* pv, float* dv, float* nv, float* dl, int quiet)
{
  float *v1, *v2, *vptr, *d;
  int *sptr, a;
...
static void RepCartoonComputeTangents(int nAt, int* seg, float* nv, float* tv)
{
  float *vptr, *v1;
  int *sptr, a;
  sptr = seg;
  ...
  *(v1++) = *(vptr++);
  ...
  for (a = 1; a < (nAt - 1); a++) {
    if ((*sptr == *(sptr - 1)) && (*sptr == *(sptr + 1))) {
      add3f(vptr, (vptr - 3),
          v1); /* tangent vectors are head-to-tail sums within a segment */
      normalize3f(v1);
    } else if (*sptr == *(sptr - 1)) {
...
static void RepCartoonComputeRoundHelices(nuc_acid_data* ndata, const int nAt,
    const int* sptr, const ss_t* ss, const float* v0, const float* vptr)
{
  ...
  if (nAt > 1) {
    for (a = 0; a < nAt; a++) {
      if (a) {
        if (*sptr !=
            *(sptr - 1)) { /* contiguous helices in disconnected segments */
          v1 = nullptr;
          v2 = nullptr;
          v3 = nullptr;
          v4 = nullptr;
...
static void RepCartoonRefineNormals(PyMOLGlobals* G, RepCartoon* I,
    ObjectMolecule* obj, CoordSet* cs, nuc_acid_data* ndata, const int nAt,
    const int* seg, const float* tv, float* pvo, float* pva, const ss_t* ss,
    const float* nv)
{
  int refine_normals = SettingGet_i(G, cs->Setting.get(), obj->Setting.get(),
      cSetting_cartoon_refine_normals);
  if (refine_normals < 0) {
    if (obj->NCSet > 1) {
      int i, n_set = 0;
  ...
  if (refine_normals) {
    ...
    for (a = 1; a < (nAt - 1); a++) {
      if ((*sptr == *(sptr + 1)) &&
          (*sptr == *(sptr - 1))) { /* only operate within a segment */
        remove_component3f(
            ndata->voptr - 3, vptr - 3, o0); /* previous orientation vector */
        normalize3f(o0); /* is now perp to chain direction */
        v1 = va;         /* candidate orientation vectors for current CA */
        remove_component3f(v1, vptr - 3,
            o1); /* removes chain direction from the two candidates */
        ...
        copy3f(v0,
            ndata->voptr); /* updates atom with optimal orientation vector */
      }
      ndata->voptr += 3;
    ...
    for (a = 1; a < (nAt - 1); a++) {
      if ((*sptr == *(sptr - 1)) && (*sptr == *(sptr + 1))) {
        dp = (dot_product3f(ndata->voptr, ndata->voptr + 3) *
              dot_product3f(ndata->voptr, ndata->voptr - 3));
...
static void RepCartoonFlattenSheets(PyMOLGlobals* G, ObjectMolecule* obj,
    CoordSet* cs, nuc_acid_data* ndata, int nAt, const int* sptr,
    const CCInOut* cc, float* pv, float* pvo, const ss_t* ss, const float* v0,
    float* tmp, const int* flag_tmp)
{
  int last, first, cur_car, end_flag, a, b, c, e, f;
  int flat_cycles;
  float t0[3];
  flat_cycles = SettingGet_i(
      G, cs->Setting.get(), obj->Setting.get(), cSetting_cartoon_flat_cycles);
...
static void RepCartoonFlattenSheetsRefineTips(PyMOLGlobals* G,
    ObjectMolecule* obj, CoordSet* cs, int nAt, int* seg, const ss_t* ss,
    float* tv)
{
  int *sptr, a;
  float* v2;
  float refine_tips;
  float t0[3];
  refine_tips = SettingGet_f(
      G, cs->Setting.get(), obj->Setting.get(), cSetting_cartoon_refine_tips);
  sptr = seg + 1;
  ++ss;
  v2 = tv + 3; /* normal */
  for (a = 1; a < (nAt - 1); a++) {
    if ((*ss == ss_t::SHEET) && (*sptr == *(sptr + 1)) &&
        (*sptr == *(sptr - 1))) { /* sheet in same segment */
      if ((*ss == *(ss + 1)) && (*ss != *(ss - 1))) { /* start, bias forwards */
        scale3f(v2 + 3, refine_tips, t0);
        add3f(t0, v2, v2);
        normalize3f(v2);
      } else if ((*ss != *(ss + 1)) &&
                 (*ss == *(ss - 1))) { /* end, bias backwards */
        scale3f(v2 - 3, refine_tips, t0);
        add3f(t0, v2, v2);
        normalize3f(v2);
      }
...
static void RepCartoonSmoothLoops(PyMOLGlobals* G, ObjectMolecule* obj,
    ...
    const int* flag_tmp)
{
  ...
  smooth_first = SettingGet_i(
      G, cs->Setting.get(), obj->Setting.get(), cSetting_cartoon_smooth_first);
  smooth_last = SettingGet_i(
      G, cs->Setting.get(), obj->Setting.get(), cSetting_cartoon_smooth_last);
  smooth_cycles = SettingGet_i(
      G, cs->Setting.get(), obj->Setting.get(), cSetting_cartoon_smooth_cycles);
...
Rep* RepCartoonNew(CoordSet* cs, int state)
{
  ...
  int na_mode;
  int* flag_tmp;
  float putty_vals[4] = {10.0F, 0.0F, FLT_MAX,
      -FLT_MAX}; // putty_mean, putty_stdev, putty_min, putty_max
  ...
  alpha = 1.0F - SettingGet_f(G, cs->Setting.get(), obj->Setting.get(),
                     cSetting_cartoon_transparency);
  round_helices = SettingGet_i(
      G, cs->Setting.get(), obj->Setting.get(), cSetting_cartoon_round_helices);
  na_mode = SettingGet_i(G, cs->Setting.get(), obj->Setting.get(),
      cSetting_cartoon_nucleic_acid_mode);
  ladder_mode = SettingGet_i(
      G, cs->Setting.get(), obj->Setting.get(), cSetting_cartoon_ladder_mode);
  ...
  pva = pymol::malloc<float>(
      nAtIndex * 6); /* alternative orientation vectors, two per atom */
  ...
  auto cartoon_all_alt = SettingGet_b(
      G, cs->Setting.get(), obj->Setting.get(), cSetting_cartoon_all_alt);
  ...
  do {
    ...
    ndata.vptr = pv;
    ndata.voptr = pvo;
    ndata.ring_mode = SettingGet_i(
        G, cs->Setting.get(), obj->Setting.get(), cSetting_cartoon_ring_mode);
    ndata.ring_finder = SettingGet_i(
        G, cs->Setting.get(), obj->Setting.get(), cSetting_cartoon_ring_finder);
    ...
    if (nAt) {
      dv = pymol::malloc<float>(
          nAt * 3); /* differences between next and current 3f */
      nv = pymol::malloc<float>(nAt * 3); /* normal */
      dl = pymol::malloc<float>(
          nAt); /* length (i.e., normal * length = difference) */
      ...
      RepCartoonRefineNormals(
          G, I, obj, cs, &ndata, nAt, seg, tv, pvo, pva, sstype, nv);

      {
        int smooth_loops = SettingGet_i(G, cs->Setting.get(),
            obj->Setting.get(), cSetting_cartoon_smooth_loops);
        bool cartoon_flat_sheets = SettingGet_b(G, cs->Setting.get(),
            obj->Setting.get(), cSetting_cartoon_flat_sheets);
        if (smooth_loops || cartoon_flat_sheets) {
          if (cartoon_flat_sheets) {
            RepCartoonFlattenSheets(G, obj, cs, &ndata, nAt, seg, car, pv, pvo,
                sstype, tv, tmp, flag_tmp);
          }
          if (smooth_loops) {
            RepCartoonSmoothLoops(G, obj, cs, &ndata, nAt, seg, pv, sstype, pvo,
                tv, tmp, flag_tmp);
          }
          /* recompute differences and normals */
          RepCartoonComputeDifferencesAndNormals(
              G, nAt, seg, pv, dv, nv, dl, true);
          /* recompute tangents */
          RepCartoonComputeTangents(nAt, seg, nv, tv);
          if (cartoon_flat_sheets) {
