...
int getMacroModelAtomType(const AtomInfoType* ai)
{
  ...
  case -2:
    switch (ai->protons) {
    case cAN_S:
      return 114; // Sm Sulfide anion, S2-
    case cAN_O:
      return 115; // Om Oxide anion, O2-
    }
    break;
  case -1:
    switch (ai->protons) {
    case cAN_C:
      return 10; // CM Carbanion (C-)
    case cAN_O:
      return 18; // OM O- (alkoxide, carboxylate)
    case cAN_H:
      return 45; // H5 H- (Anion)
    case cAN_S:
      return 51; // SM S- (thiolate anion)
    case cAN_Cl:
      return 102; // Cm Cl-
    case cAN_F:
      return 104; // Fm F-
  ...
  case 0:
    switch (ai->protons) {
    case cAN_Li:
      return 93; // L0 Lithium neutral
    case cAN_Mg:
      return 94; // M0 Magnesium neutral
    }
    break;
  case 1:
    switch (ai->protons) {
    case cAN_C:
      return 11; // CP Carbocation (C+)
    case cAN_H:
      return 44; // H4 H+ (Cation)
    case cAN_Li:
      return 65; // Li Li+
    case cAN_Na:
      return 66; // Na Na+
  ...
  case cAN_C:
    ...
    case cAtomInfoLinear:
      return 1; // C1 Carbon - sp
    case cAtomInfoPlanar:
      return 2; // C2 Carbon - sp2
    case cAtomInfoTetrahedral:
      return 3; // C3 Carbon - sp3
    }
  ...
  case cAN_O:
    ...
    switch (ai->geom) {
    case cAtomInfoPlanar:
      return 15; // O2 Oxygen - double bond
    case cAtomInfoTetrahedral:
      return 16; // O3 Oxygen - single bond
    }
  ...
  case cAN_P:
    if (ai->geom == cAtomInfoTetrahedral) {
      switch (ai->valence) {
      case 3:
        return 53; // P3 Phosphorus, trivalent
      case 4:
        return 107; // P5 Phosphorus, pentavalent tetrahedral
      }
    }
  ...
  case cAN_B:
    switch (ai->geom) {
    case cAtomInfoPlanar:
      return 54; // B2 Boron - sp2
    case cAtomInfoTetrahedral:
      return 55; // B3 Boron - sp3
    }
