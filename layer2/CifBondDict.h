...
public:
  ...
  void set_unknown(const char* resn) { unknown_resn.insert(make_key(resn)); }

  const mapped_type* get(
      PyMOLGlobals*, const char* resn, bool try_download = true);
};
