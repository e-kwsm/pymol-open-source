...
#define CPythonVal_PConvPyIntToInt_From_List(G, list, i, ptr)                  \
  PConvPyIntToInt(PyList_GetItem(list, i), ptr)
#define CPythonVal_PConvPyFloatToFloat_From_List(G, list, i, ptr)              \
  PConvPyFloatToFloat(PyList_GetItem(list, i), ptr)
#define CPythonVal_PConvPyListToIntArrayInPlace(G, obj, ff, ll)                \
  PConvPyListToIntArrayInPlace(obj, ff, ll)
#define CPythonVal_PConvPyListToIntArrayInPlace_From_List(G, list, i, ff, ll)  \
  PConvPyListToIntArrayInPlace(PyList_GetItem(list, i), ff, ll)
#define CPythonVal_PConvPyListToFloatArrayInPlaceAutoZero_From_List(           \
    G, list, i, ...)                                                           \
...
#define CPythonVal_PConvPyListToFloatVLANoneOkay_From_List(G, list, i, f)      \
  PConvPyListToFloatVLANoneOkay(PyList_GetItem(list, i), f)
#define CPythonVal_PConvPyListToLabPosVec(G, obj) PConvPyListToLabPosVec(obj)
#define CPythonVal_PConvPyStrToStr_From_List(G, list, i, ptr, l)               \
  PConvPyStrToStr(PyList_GetItem(list, i), ptr, l)
...
#define CPythonVal_Tuple_SetItem(TUPLE, ITEM, VAL)                             \
  PyTuple_SetItem(TUPLE, ITEM, VAL)
#define CPythonVal_New_String(BUF, LEN) PyString_FromStringAndSize(BUF, LEN)
#define CPythonVal_New_Boolean(VAL)                                            \
  (VAL ? PyBool_FromLong(1) : PyBool_FromLong(0))
...
int PConvAttrToStrMaxLen(
    PyObject* obj, const char* attr, char* str, ov_size ll);

int PConvPyListToBitmask(PyObject* obj, int* bitmask, ov_size ll);
int PConvPyListToExtent(PyObject* obj, float* mn, float* mx);

int PConvAttrToFloatArrayInPlace(
    PyObject* obj, const char* attr, float* ff, ov_size ll);
int PConvAttrToIntArrayInPlace(
    PyObject* obj, const char* attr, int* ff, ov_size ll);
...
void PConv44PyListTo44f(
    PyObject* src, float* dest); /* note loss of precision */
...
#define PConvPyListToFloatArray(obj, f)                                        \
  PConvPyListToFloatArrayImpl(obj, f, false)
...
int PConvPyListToFloatArrayInPlaceAutoZero(
    PyObject* obj, float* ii, ov_size ll);

int PConvPyListToDoubleArrayInPlace(PyObject* obj, double* ff, ov_size ll);

PyObject* PConvFloatArrayToPyList(
    const float* f, int l, bool dump_binary = false);
...
int PConvPyListToSIntArrayInPlaceAutoZero(
    PyObject* obj, short int* ii, ov_size ll);
int PConvPyListToSCharArrayInPlaceAutoZero(
    PyObject* obj, signed char* ii, ov_size ll);
...
template <class T> PyObject* PConvToPyObject(const std::vector<T>& v)
{
  int n = v.size();
 ...
 */
template <class T> PyObject* PConvToPyObject(const std::set<T>& v)
{
  size_t i = 0, n = v.size();
  PyObject* o = PyList_New(n);
 ...
 */
template <class K, class V> PyObject* PConvToPyObject(const std::map<K, V>& v)
{
  size_t i = 0, n = v.size();
