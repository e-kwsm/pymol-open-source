...
public:
  ...
  void set_3f(const float* value) { set_3f(value[0], value[1], value[2]); }
 ...
 * bool overload
 */
inline int SettingUniqueSetTypedValue(PyMOLGlobals* G, int unique_id,
    int setting_id, int setting_type, const bool* value)
{
  int i = *value;
...
bool SettingUniqueSetPyObject(
    PyMOLGlobals* G, int unique_id, int setting_id, PyObject* value);
#endif
...
void SettingRestoreDefault(
    CSetting* I, int index, const CSetting* src = nullptr);
...
template <> inline int SettingGetType<bool>()
{
  return cSetting_boolean;
}
template <> inline int SettingGetType<int>()
{
  return cSetting_int;
}
template <> inline int SettingGetType<float>()
{
  return cSetting_float;
}
template <> inline int SettingGetType<const float*>()
{
  return cSetting_float3;
}
template <> inline int SettingGetType<float*>()
{
  return cSetting_float3;
}
template <> inline int SettingGetType<const char*>()
{
  return cSetting_string;
}
template <> inline int SettingGetType<char*>()
{
  return cSetting_string;
}
...
PyObject* SettingGetTuple(PyMOLGlobals* G, const CSetting* set1,
    const CSetting* set2, int index); /* (type,(value,)) */
...
std::vector<int> SettingGetUpdateList(
    PyMOLGlobals* G, const char* name = "", int state = 0);
...
inline void SettingSet(CSetting* s, int i, bool v)
{
  SettingSet_b(s, i, v);
}
inline void SettingSet(CSetting* s, int i, int v)
{
  SettingSet_i(s, i, v);
}
inline void SettingSet(CSetting* s, int i, long int v)
{
  SettingSet_i(s, i, v);
}
inline void SettingSet(CSetting* s, int i, float v)
{
  SettingSet_f(s, i, v);
}
inline void SettingSet(CSetting* s, int i, const char* v)
{
  SettingSet_s(s, i, v);
}
inline void SettingSet(CSetting* s, int i, const float* v)
{
  SettingSet_3fv(s, i, v);
}
...
template <typename V>
void SettingSet(
    PyMOLGlobals* G, pymol::copyable_ptr<CSetting>& handle, int index, V value)
{
...
/**
 * Return setting value if it's defined in the given set, or `default_`
 * otherwise.
 */
template <typename V> V SettingGetWD(const CSetting* s, int index, V default_)
{
  V out;
...
bool SettingUniqueGetTypedValuePtr(
    PyMOLGlobals* G, int unique_id, int index, int setting_type, void* out);

/*
 * bool overload
 */
inline bool SettingUniqueGetTypedValuePtr(
    PyMOLGlobals* G, int unique_id, int index, int setting_type, bool* out)
{
  int i = *out;
 ...
 */
template <typename V>
bool SettingUniqueGetIfDefined(
    PyMOLGlobals* G, int unique_id, int index, V* out)
{
  return SettingUniqueGetTypedValuePtr(
      G, unique_id, index, SettingGetType<V>(), out);
}
