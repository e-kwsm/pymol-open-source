...
void MovieAppendSequence(
    PyMOLGlobals* G, const char* seq, int start_from, bool freeze);
int MovieSeekScene(PyMOLGlobals* G, int loop);
int MoviePNG(PyMOLGlobals* G, const char* prefix, int save, int start, int stop,
    int missing_only, int modal, int format, int mode, int quiet, int width = 0,
    int height = 0);
...
int MovieMatrix(
    PyMOLGlobals* G, int action); /* 0 clear, 1 remember, 2 recall */
