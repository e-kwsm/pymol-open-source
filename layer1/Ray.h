...
void RayPrepare(CRay* I, float v0, float v1, float v2, float v3, float v4,
    ...
    float pixel_ratio, float back_ratio, float magnified);
...
struct _CRay {
  ...
  int customCylinder3fv(const cgo::draw::custom_cylinder& cyl);
  int customCylinder3fv(const float* v1, const float* v2, float r,
  ...
  int cone3fv(const float* v1, const float* v2, float r1, float r2,
      const float* c1, const float* c2, cCylCap cap1, cCylCap cap2);
  int sausage3fv(const float* v1, const float* v2, float r, const float* c1,
      const float* c2);
  void color3fv(const float* c);
  int triangle3fv(const float* v1, const float* v2, const float* v3,
      const float* n1, const float* n2, const float* n3, const float* c1,
      const float* c2, const float* c3);
  int triangleTrans3fv(const float* v1, const float* v2, const float* v3,
      const float* n1, const float* n2, const float* n3, const float* c1,
  ...
  int ellipsoid3fv(const float* v, float r, const float* n1, const float* n2,
      const float* n3);
...
private:
  int cylinder3fv(const float* v1, const float* v2, float r, const float* c1,
      const float* c2, const float alpha1, const float alpha2);
};
