...
static const char* backbone_names[] = {
    ...
    "CA", "C", "O", "N", "OXT", "H",
    // nucleic acid
    "P", "OP1", "OP2", "OP3", "C1'", "C2'", "O2'", "C3'", "O3'", "C4'", "O4'",
    "C5'", "O5'", "H1'", "H3'", "H4'", "H2'", "H2''", "H12'", "H22'", "H5'",
    "H5''", "H15'", "H25'", "HO2'", "HO3'", "HO5'", ""};
...
static pymol::Result<sele_array_t> SelectorSelect(PyMOLGlobals* G,
    const char* sele, int state, SelectorID_t domain, int quiet);
...
static int SelectorEmbedSelection(PyMOLGlobals* G, const int* atom,
    pymol::zstring_view name, ObjectMolecule* obj, int no_dummies,
    int exec_manage);
...
static WordKeyValue Keyword[] = {{"not", SELE_NOT1}, {"!", SELE_NOT1},

    {"neighbor", SELE_NGH1}, {"nbr;", SELE_NGH1}, /* deprecated */
    {"nbr.", SELE_NGH1},

    {"byfragment", SELE_BYF1}, {"byfrag", SELE_BYF1}, {"bf.", SELE_BYF1},

    {"byresidue", SELE_BYR1}, {"byresi", SELE_BYR1}, /* unofficial */
    {"byres", SELE_BYR1}, {"br;", SELE_BYR1},        /* deprecated */
    {"br.", SELE_BYR1}, {"b;", SELE_BYR1},           /* deprecated */

    {"bychain", SELE_BYC1}, {"bc.", SELE_BYC1},

    {"byobject", SELE_BYO1}, {"byobj", SELE_BYO1},
    {"bo;", SELE_BYO1}, /* deprecated */
    {"bo.", SELE_BYO1},

    {"bound_to", SELE_BON1}, {"bto.", SELE_BON1},

    {"bymolecule", SELE_BYM1}, {"bymol", SELE_BYM1}, {"bm.", SELE_BYM1},

    {"bysegment", SELE_BYS1}, {"byseg", SELE_BYS1},
    {"bysegi", SELE_BYS1}, /* unofficial */
    {"bs.", SELE_BYS1},

    {"bycalpha", SELE_CAS1}, {"bca.", SELE_CAS1},

    {"first", SELE_FST1}, {"last", SELE_LST1},

    {"and", SELE_AND2}, {"&", SELE_AND2}, {"or", SELE_OR_2},
    {"+", SELE_OR_2}, /* added to mitigate damage caused by the obj1+obj2 parser
                         bug */
    {"-", SELE_ANT2}, /* added to provide natural complement to the above: an
                         AND NOT or SUBTRACT operation */
    {"|", SELE_OR_2}, {"in", SELE_IN_2},

    {"like", SELE_LIK2}, {"l;", SELE_LIK2}, {"l.", SELE_LIK2},
    ...
    {"name", SELE_NAMs}, {"n;", SELE_NAMs}, /* deprecated */
    {"n.", SELE_NAMs},

    {"symbol", SELE_ELEs}, {"element", SELE_ELEs}, {"elem", SELE_ELEs},
    {"e;", SELE_ELEs}, /* deprecated */
    {"e.", SELE_ELEs},

    {"enabled", SELE_ENAz},

    {"residue", SELE_RSIs}, {"resi", SELE_RSIs}, {"resident", SELE_RSIs},
    {"resid", SELE_RSIs}, {"i;", SELE_RSIs}, /* deprecated */
    {"i.", SELE_RSIs},

    {"rep", SELE_REPs},

    {"color", SELE_COLs}, {"cartoon_color", SELE_CCLs},
    {"ribbon_color", SELE_RCLs},

    {"altloc", SELE_ALTs}, {"alt", SELE_ALTs},

    {"flag", SELE_FLGs}, {"f;", SELE_FLGs}, /* deprecated */
    {"f.", SELE_FLGs},

    {"gap", SELE_GAP_},

    {"partial_charge", SELE_PCHx}, {"pc;", SELE_PCHx}, /* deprecated */
    {"pc.", SELE_PCHx},

    {"masked", SELE_MSKz}, {"msk.", SELE_MSKz},

    {"protected", SELE_PTDz},

    {"formal_charge", SELE_FCHx}, {"fc;", SELE_FCHx}, /* deprecated */
    {"fc.", SELE_FCHx},

    {"numeric_type", SELE_NTYs}, {"nt;", SELE_NTYs}, /* deprecated */
    {"nt.", SELE_NTYs},

    {"text_type", SELE_TTYs}, {"custom", SELE_CUST},
    {"tt;", SELE_TTYs}, /* deprecated */
    {"tt.", SELE_TTYs},

    {"chain", SELE_CHNs}, {"c;", SELE_CHNs}, /* deprecated */
    {"c.", SELE_CHNs},

    {cKeywordCenter, SELE_CENz}, {"bonded", SELE_BNDz},

    {"segment", SELE_SEGs}, {"segid", SELE_SEGs}, {"segi", SELE_SEGs},
    ...
    {"object", SELE_MODs}, {"o.", SELE_MODs},

    {cKeywordOrigin, SELE_ORIz},

    {"model", SELE_MODs}, {"m;", SELE_MODs}, /* deprecated */
    {"m.", SELE_MODs},

    {"index", SELE_IDXs}, {"idx.", SELE_IDXs},

    {"id", SELE_ID_s}, {"ID", SELE_ID_s}, {"rank", SELE_RNKs},

    {"within", SELE_WIT_}, {"w.", SELE_WIT_},

    {"near_to", SELE_NTO_}, {"nto.", SELE_NTO_},

    {"beyond", SELE_BEY_}, {"be.", SELE_BEY_},

    {"donors", SELE_DONz}, {"don.", SELE_DONz},

    {"acceptors", SELE_ACCz}, {"acc.", SELE_ACCz},

    {"pepseq", SELE_PEPs}, {"ps.", SELE_PEPs},
    ...
    {"fixed", SELE_FXDz}, {"fxd.", SELE_FXDz},

    {"restrained", SELE_RSTz}, {"rst.", SELE_RSTz},

    {"polymer", SELE_POLz}, {"pol.", SELE_POLz},

    {"polymer.protein", SELE_PROz}, {"polymer.nucleic", SELE_NUCz},
  ...
  {"nuc.", SELE_NUCz},
    ...
    {"organic", SELE_ORGz}, {"org.", SELE_ORGz},

    {"inorganic", SELE_INOz}, {"ino.", SELE_INOz},

    {"solvent", SELE_SOLz}, {"sol.", SELE_SOLz},

    {"guide", SELE_GIDz},

    {"present", SELE_PREz}, {"pr.", SELE_PREz},

    {"resname", SELE_RSNs}, {"resn", SELE_RSNs},
    {"r;", SELE_RSNs}, /* deprecated */
    {"r.", SELE_RSNs},

    {"%", SELE_SELs}, {"b", SELE_BVLx}, /* 2 operand selection operator */
    ...
    {"backbone", SELE_BB_z}, {"bb.", SELE_BB_z},

    {"sidechain", SELE_SC_z}, {"sc.", SELE_SC_z},

    {"p.", SELE_PROP},

    {"x", SELE_XVLx}, {"y", SELE_YVLx}, {"z", SELE_ZVLx},

    {"byring", SELE_RING}, {"label", SELE_LABs},
...
static WordKeyValue AtOper[] = {{">", SCMP_GTHN}, {"<", SCMP_LTHN},
    {"in", SCMP_RANG}, {"=", SCMP_EQAL}, {"", 0}};
...
int SelectorResidueVLAsTo3DMatchScores(PyMOLGlobals* G, CMatch* match,
    int* vla1, int n1, int state1, int* vla2, int n2, int state2, float seq_wt,
    float radius, float scale, float base, float coord_wt, float rms_exp)
{
                      ...
                      while ((mem3 = neighbor[nbr2]) >= 0) {
                        if ((mem3 != mem1) && (mem3 != mem0)) {
                          ...
                          if (idx_cb2 >= 0) {
                            ...
                            {
                              float angle =
                                  get_dihedral3f(v_cb1, v_ca1, v_ca2, v_cb2);
                              if (idx_cb1 < idx_cb2) {
      ...
      if ((scale != 0.0F) || (seq_wt != 0.0F)) {
        for (a = 0; a < n1; a++) {
          ...
          for (b = 0; b < n2; b++) {
            ...
            comp1 = (float) ((sqrt(sm[0] * sm[0] + sm[1] * sm[1]) +
                                 sqrt(sm[2] * sm[2] + sm[3] * sm[3])) *
                             0.25);
            comp2 = (float) ((sqrt(sm[4] * sm[4] + sm[5] * sm[5]) +
                                 sqrt(sm[6] * sm[6] + sm[7] * sm[7])) *
                             0.25);
...
int SelectorClassifyAtoms(
    PyMOLGlobals* G, int sele, int preserve, ObjectMolecule* only_object)
{
  CSelector* I = G->Selector;
  ...
  int auto_show_classified =
      SettingGetGlobal_i(G, cSetting_auto_show_classified);
  ...
  if (auto_show_classified == -1 && only_object &&
      only_object->NAtom *
              (only_object->DiscreteFlag ? 1 : only_object->NCSet) >
          5e5) {
  ...
  if (only_object) {
    SelectorUpdateTableSingleObject(
        G, only_object, cSelectorUpdateTableAllStates, true);
    n_dummies = 0;
  } else {
    SelectorUpdateTable(G, cSelectorUpdateTableAllStates, -1);
  ...
  while (a < I->Table.size()) {
    ...
    if (SelectorIsMember(G, ai->selEntry, sele) &&
      ...
      if (!ai->hetatm && AtomInfoKnownProteinResName(LexStr(G, ai->resn)))
        ...
        for (aa = a0; aa <= a1; aa++) {
          if (ai0->protons == cAN_C) {
            ...
            case 'C':
              ...
              case 0:
                found_c = true;
                found_cn_bond = ObjectMoleculeIsAtomBondedToName(
                    obj, I->Table[aa].atom, "N", 0);
                break;
              case 'A':
                switch (name[2]) {
                case 0:
            ...
            case 'N':
              ...
              case 0:
                found_n = true;
                found_nc_bond = ObjectMoleculeIsAtomBondedToName(
                    obj, I->Table[aa].atom, "C", 0);
                break;
              }
            }
            ...
            case 'O':
              ...
              case '3':
                ...
                case '\'':
                  found_o3star = true;
                  found_o3_bond = ObjectMoleculeIsAtomBondedToName(
                      obj, I->Table[aa].atom, "P", 0);
                  break;
                }
                break;
              case '5':
            ...
            case 'P':
              switch (name[1]) {
              case 0:
                found_p_bond = (ObjectMoleculeIsAtomBondedToName(
                                    obj, I->Table[aa].atom, "O3*", 0) ||
                                ObjectMoleculeIsAtomBondedToName(
                                    obj, I->Table[aa].atom, "O3'", 0));
                break;
              }
            }
        ...
        if (found_ca && found_n && found_c && found_o &&
            (found_cn_bond || found_nc_bond)) {
          mask = cAtomFlag_polymer | cAtomFlag_protein;
        } else if (found_o3star && found_c3star && found_c4star &&
                   found_c5star && found_o5star &&
          ...
          if (SelectorIsMember(G, ai0->selEntry, sele)) {
            ...
            if (auto_show_classified && !(ai0->flags & cAtomFlag_class)) {
              if (mask & cAtomFlag_organic) {
                ...
                ai0->visRep =
                    (ai0->visRep & auto_show_mask) | visRep_polymer_obj;
              }
...
MapType* SelectorGetSpacialMapFromSeleCoord(
    PyMOLGlobals* G, int sele, int state, float cutoff, float** coord_vla)
{
    ...
    int preserve, ObjectMolecule* single_object, int quiet)
{
  ...
  for (state = state_start; state < state_stop; state++) {
    ...
    if (first_pass) {
          ...
          if ((ai->protons == cAN_C) &&
...

            {
              ...
              for (aa = a0 + 1; aa < a1; aa++) {
                ...
                if ((ai->protons == cAN_C) &&
                    (WordMatchExact(G, G->lex_const.C, ai->name, true))) {
                  found_C = aa;
                }
                if ((ai->protons == cAN_N) &&
                    (WordMatchExact(G, G->lex_const.N, ai->name, true))) {
                  found_N = aa;
                }
                if ((ai->protons == cAN_O) &&
                    (WordMatchExact(G, G->lex_const.O, ai->name, true))) {
                  found_O = aa;
                }
              }
              ...
              if ((found_C) && (found_N) && (found_O)) {
                ...
                if (!quiet) {
                  ...
                  " AssignSS-Warning: Ignoring incomplete residue "
                  "/%s/%s/%s/%d%c ...\n",
                      obj->Name, LexStr(G, ai->segi), LexStr(G, ai->chain),
                      ai->resv, ai->getInscode(true) ENDFB(G);
                }
              }
            }
          }
      ...
      if (preserve) { /* if we're in preserve mode, then mark which objects
                         don't get changed */
        int a, b;
        char ss;
      ...
      /* now, let's repack res. into discrete chunks so that we can do easy gap
       * & ladder analysis */

      {
        ...
        for (a = 0; a < n_res; a++) {
          ...
          if (!a) {
            ...
            if (!ObjectMoleculeCheckBondSep(res[a].obj, at_ca0, at_ca1,
                    3)) { /* CA->N->C->CA = 3 bonds */
              add_break = true;
            }
          }
...

    {
      ...
      if (n1) {
            ...
            if (res[a0].obj) {
              ...
              for (const auto as1 : MapEIter(*map, v0)) {
                ...
                if (within3f(v0, v1, cutoff)) {
                  ...
                  if (obj0 ==
                      obj1) { /* don't count hbonds between adjacent residues */
                    exclude = SelectorCheckNeighbors(
                        G, 5, obj0, at0, at1, zero, scratch);
                  } else {
                    exclude = false;
                  }
                   ...
                   */
                  if ((!exclude) && ObjectMoleculeGetCheckHBond(NULL, nullptr,
                                        obj1,             /* donor first */
                                        at1, state, obj0, /* then acceptor */
                                        at0, state, hbc)) {

                    /*                        printf(" found hbond between
                       acceptor resi %s and donor resi %s\n",
              ...
              if (nat > 1000) { // if map returns more than 1000 atoms within 4,
                                // should be a dss error
                too_many_atoms = true;
                break;
              }
            }
        ...
        if (too_many_atoms) {
          ...
          " %s: ERROR: Unreasonable number of neighbors for dss, cannot assign "
          "secondary structure.\n",
              __func__ ENDFB(G);
        }
      }
    ...
    { /* compute phi, psi's */
      ...
      float helix_psi_target =
          SettingGet_f(G, nullptr, nullptr, cSetting_ss_helix_psi_target);
      ...
      float helix_phi_target =
          SettingGet_f(G, nullptr, nullptr, cSetting_ss_helix_phi_target);
...

    {
      ...
      for (a = cSSBreakSize; a < (n_res - cSSBreakSize); a++) {
        ...
        if (r->real) {
          ...
          for (b = 0; b < r->n_acc; b++) {
            r->flags |= ((r->acc[b] == (a + 3)) ? cSSHelix3HBond : 0) |
          ...
          for (b = 0; b < r->n_don; b++) {
            r->flags |= ((r->don[b] == (a - 3)) ? cSSHelix3HBond : 0) |
                        ((r->don[b] == (a - 4)) ? cSSHelix4HBond : 0) |
                        ((r->don[b] == (a - 5)) ? cSSHelix5HBond : 0);
          }

          /*        if(r->flags & (cSSHelix3HBond | cSSHelix4HBond |
             cSSHelix5HBond)) { printf("HelixHB %s \n",
...

    {
      ...
      for (a = cSSBreakSize; a < (n_res - cSSBreakSize); a++) {
        ...
        if (r->real) {
          ...
          if (((r - 1)->flags &
                  (cSSHelix3HBond | cSSHelix4HBond | cSSHelix5HBond)) &&
              ((r)->flags &
                  (cSSHelix3HBond | cSSHelix4HBond | cSSHelix5HBond)) &&
              ((r + 1)->flags &
                  (cSSHelix3HBond | cSSHelix4HBond | cSSHelix5HBond))) {
      ...
      for (a = cSSBreakSize; a < (n_res - cSSBreakSize); a++) {
        ...
        if (r->real) {
          ...
          /* deciding where the helix ends is trickier -- here we use helix
           * geometry */
      ...
      for (a = cSSBreakSize; a < (n_res - cSSBreakSize); a++) {
        ...
        if (r->real) {
          ...
          if (((r)->flags &
                  (cSSAntiStrandBuldgeHB)) && /* no strand geometry filtering
                                                 for buldges.. */
          ...
          if (((r - 1)->flags & (cSSAntiStrandDoubleHB)) &&
              ...
              (!(((r)->flags & (cSSPhiPsiNotStrand)))) &&
              ((r + 1)->flags &
                  (cSSAntiStrandSingleHB | cSSAntiStrandDoubleHB))) {
          ...
          if (((r - 1)->flags & (cSSParaStrandDoubleHB)) &&
              ...
              (!(((r)->flags & (cSSPhiPsiNotStrand)))) &&
              ((r + 1)->flags &
                  (cSSParaStrandSingleHB | cSSParaStrandDoubleHB))) {
        ...
        for (a = cSSBreakSize; a < (n_res - cSSBreakSize); a++) {
          ...
          if (r->real) {
            ...
            if ((r->ss == 'S') &&
              ...
              if (!found) {
                /* allow these strand "skip" residues to persist if a neighbor
                 * has hydrogen bonds */
...

    {
      int a;
      for (a = 0; a < n_res;
          a++) { /* now apply consensus or union behavior, if appropriate */
        if (res[a].present) {
          if (res[a].ss_save) {
...
int SelectorColorectionApply(
    PyMOLGlobals* G, PyObject* list, const char* prefix)
{
#ifdef _PYMOL_NOPY
  return 0;
#else
  ...
  if (ok) {
    ...
    for (b = 0; b < n_used; b++) { /* update selection indices */
      auto name =
          pymol::string_format(cColorectionFormat, prefix, used[b].color);
...
int SelectorColorectionSetName(
    PyMOLGlobals* G, PyObject* list, const char* prefix, char* new_prefix)
{
#ifdef _PYMOL_NOPY
  return 0;
#else
  ...
  if (ok) {
    for (b = 0; b < n_used; b++) { /* update selection indices */
      auto name =
          pymol::string_format(cColorectionFormat, prefix, used[b].color);
      auto new_name =
          pymol::string_format(cColorectionFormat, new_prefix, used[b].color);
...
int SelectorVdwFit(PyMOLGlobals* G, int sele1, int state1, int sele2,
...
int SelectorGetPairIndices(PyMOLGlobals* G, int sele1, int state1, int sele2,
    int state2, int mode, float cutoff, float h_angle, int** indexVLA,
          ...
          if ((idx1 >= 0) && (idx2 >= 0)) {
            ...
            if (dist < cutoff) {
              if (mode == 1) { /* coarse hydrogen bonding assessment */
                flag = false;
                if (ObjectMoleculeGetAvgHBondVector(
                        obj1, at1, state1, v1, nullptr) > 0.3)
                  if (dot_product3f(v1, dir) < -angle_cutoff)
                    flag = true;
                if (ObjectMoleculeGetAvgHBondVector(
                        obj2, at2, state2, v2, nullptr) > 0.3)
...
/*========================================================================*/
int SelectorCreateAlignments(PyMOLGlobals* G, int* pair, int sele1, int* vla1,
    int sele2, int* vla2, const char* name1, const char* name2, int identical,
    int atomic_input)
{
  CSelector* I = G->Selector;
  ...
  if (np) {
    ...
    SelectorUpdateTable(
        G, cSelectorUpdateTableAllStates, -1); /* unnecessary? */
    ...
    p = pair;
    for (i = 0; i < np;
        i++) { /* iterate through all pairs of matched residues */
      vi1 = *(p++);
      vi2 = *(p++);

      /* find positions in the selection arrays */
      /* SelectorGetResidueVLA returns a VLA with 3 entries per atom,
       * index0=model, index1=atom#, hence: *3, and *3+1 */
      mod1 = vla1[vi1 * 3];
      at1 = vla1[vi1 * 3 + 1];
      ...
      if (atomic_input) {
        ...
        while (at1a > 0 && AtomInfoSameResidue(G, ai1a, ai1a - 1)) {
          ai1a--;
          at1a--;
        }
        while (at2a > 0 && AtomInfoSameResidue(G, ai2a, ai2a - 1)) {
          ai2a--;
          at2a--;
        }
        ...
        while (1) { /* match up all matching atom names in each residue */
          ...
          if (cmp == 0) { /* atoms match */
            ...
            " S.C.A.-DEBUG: compare %s %s %d\n", LexStr(G, ai1a->name),
                LexStr(G, ai2a->name),
                cmp ENDFD PRINTFD(
                    G, FB_Selector) " S.C.A.-DEBUG: entry %d %d\n",
                ai1a -> selEntry,
                ai2a->selEntry ENDFD if ((index1 >= 0) && (index2 >= 0))
            {
...
/*========================================================================*/
void SelectorSetDeleteFlagOnSelectionInObject(
    PyMOLGlobals* G, int sele, ObjectMolecule* obj, signed char val)
{
  CSelector* I = G->Selector;
...
/*========================================================================*/
int* SelectorGetResidueVLA(
    PyMOLGlobals* G, SelectorID_t sele, int ca_only, ObjectMolecule* exclude)
{
  ...
  " %s-DEBUG: exit, result = %p, size = %d\n", __func__, (void*) result,
      (unsigned int) VLAGetSize(result) ENDFD;
...
static int* SelectorGetIndexVLAImpl(
    PyMOLGlobals* G, CSelector* I, SelectorID_t sele)
        ...
        if (SelectorIsMember(G, obj->AtomInfo[at1].selEntry, sele)) {
          if (cnt < 0) {
            if (first) {
              ...
              switch (logging) {
              case cPLog_pml:
                line = pymol::string_format(
                    "_ cmd.select(\"%s\",\"(%s", name, name);
                break;
              case cPLog_pym:
                line =
                    pymol::string_format("cmd.select(\"%s\",\"(%s", name, name);
                break;
              }
              append = 1;
              cnt = 0;
 ...
 */
int SelectorIsMember(
    PyMOLGlobals* G, SelectorMemberOffset_t s, SelectorID_t sele)
{
  if (sele > 1) {
...
/*========================================================================*/
bool SelectorMoveMember(PyMOLGlobals* G, SelectorMemberOffset_t s,
    SelectorID_t sele_old, SelectorID_t sele_new)
{
  auto I = G->SelectorMgr;
  int result = false;
  while (s) {
...
/*========================================================================*/
ObjectMolecule* SelectorGetFastSingleObjectMolecule(
    PyMOLGlobals* G, SelectorID_t sele)
{
  ...
  if (it != I->Info.end()) {
    ...
    if (info.justOneObject()) {
      ...
      result = SelectorGetSingleObjectMolecule(
          G, sele); /* fallback onto slow approach */
    }
  }
  return (result);
}
...
/*========================================================================*/
ObjectMolecule* SelectorGetFastSingleAtomObjectIndex(
    PyMOLGlobals* G, SelectorID_t sele, int* index)
{
  auto I = G->SelectorMgr;
  ObjectMolecule* result = nullptr;
  auto it = std::find_if(I->Info.begin(), I->Info.end(),
  ...
  if (it != I->Info.end()) {
    ...
    if (info.justOneAtom()) {
      ...
      if (ExecutiveValidateObjectPtr(G, obj, cObjectMolecule)) {
        if ((at < obj->NAtom) &&
            SelectorIsMember(G, obj->AtomInfo[at].selEntry, sele)) {
          *index = at;
          return obj;
        }
      }
 ...
 */
ObjectMolecule* SelectorGetSingleObjectMolecule(
    PyMOLGlobals* G, SelectorID_t sele)
{
  /* slow way */
...
/*========================================================================*/
ObjectMolecule* SelectorGetFirstObjectMolecule(
    PyMOLGlobals* G, SelectorID_t sele)
{
  /* slow way */
...
/*========================================================================*/
ObjectMolecule** SelectorGetObjectMoleculeVLA(
    PyMOLGlobals* G, SelectorID_t sele)
{
  int a;
  ObjectMolecule* last = nullptr;
  ...
  while (ExecutiveIterateObjectMolecule(G, &obj, &iterator)) {
    ...
    for (int a = 0; a < obj->NAtom; a++) {
      ...
      if (SelectorIsMember(G, s, sele)) {
        if (found_it) {
          return pymol::Error(
              "More than one atom found"); /* ADD'L EXIT POINT */
        } else {
...
/*========================================================================*/
pymol::Result<std::array<float, 3>> SelectorGetSingleAtomVertex(
    PyMOLGlobals* G, int sele, int state)
{
  ...
  p_return_if_error(atom_index_result);
  {
    ...
    std::array<float, 3> v;
    auto found_it = ObjectMoleculeGetAtomTxfVertex(
        obj_idx.first, state, obj_idx.second, v.data());
    if (found_it) {
      return v;
    } else {
...
/*========================================================================*/
static int SelectorWalkTree(PyMOLGlobals* G, int* atom, int* comp, int* toDo,
    int** stk, int stkDepth, ObjectMolecule* obj, int sele1, int sele2,
    int sele3, int sele4)
{
  int c = 0;
  ...
  while (stkDepth) { /* this will explore a tree, stopping at protected atoms */
    ...
    if (!seleFlag) {
      if (!(ai->protekted ==
              cAtomProtected_explicit)) { /* if not explicitly protected... */
...
/*========================================================================*/
static int SelectorWalkTreeDepth(PyMOLGlobals* G, int* atom, int* comp,
    int* toDo, int** stk, int stkDepth, ObjectMolecule* obj, int sele1,
    int sele2, int sele3, int sele4, int** extraStk, WalkDepthRec* wd)
{
  int s;
  int c = 0;
  int seleFlag;
...
static void update_min_walk_depth(WalkDepthRec* minWD, int frag,
    WalkDepthRec* wd, int sele1, int sele2, int sele3, int sele4)
{
    ...
    const char* fragPref, const char* compName, int* bondMode)
{
  ...
  int *atom1_base = nullptr, *atom2_base = nullptr, *atom3_base = nullptr,
      *atom4_base = nullptr;
  int *toDo1_base = nullptr, *toDo2_base = nullptr, *toDo3_base = nullptr,
      *toDo4_base = nullptr;
  int *comp1_base = nullptr, *comp2_base = nullptr, *comp3_base = nullptr,
      *comp4_base = nullptr;
  int *pkset1_base = nullptr, *pkset2_base = nullptr, *pkset3_base = nullptr,
      *pkset4_base = nullptr;
    ...
    if (*bondMode) {
      if (obj1 == obj2) { /* just to be safe */
        ...
        if (a0 >= 0) {
          ...
          atom1_base[a0] = 1; /* create selection for this atom alone as
                                 fragment base atom */
          comp1_base[a0] = 1;
          name = pymol::string_format("%s%1d", fragPref, nFrag + 1);
          SelectorEmbedSelection(G, atom, name, nullptr, false, -1);
          c = SelectorWalkTree(G, atom1_base, comp1_base, toDo1_base, &stk,
                  stkDepth, obj1, sele1, sele2, -1, -1) +
              1;
        ...
        if (a0 >= 0) {
          ...
          for (auto const& neighbor : AtomNeighbors(obj1, a0)) {
            ...
            if (toDo1_base[a1]) {
              ...
              stk[0] = a1;
              UtilZeroMem(atom, sizeof(int) * I->Table.size());
              atom1_base[a1] = 1; /* create selection for this atom alone as
                                     fragment base atom */
              comp1_base[a1] = 1;
              name = pymol::string_format("%s%1d", fragPref, nFrag + 1);
              SelectorEmbedSelection(G, atom, name, nullptr, false, -1);
              atom1_base[a1] = 0;
              c = SelectorWalkTreeDepth(G, atom1_base, comp1_base, toDo1_base,
                  &stk, stkDepth, obj1, sele1, sele2, sele3, sele4, &extraStk,
                  &curWalk);
              if (c) {
                nFrag++;
                name = pymol::string_format("%s%1d", pref, nFrag);
                SelectorEmbedSelection(G, atom, name, nullptr, false, -1);
                update_min_walk_depth(
                    &minWalk, nFrag, &curWalk, sele1, sele2, sele3, sele4);
              }
            }
          }
        }
        ...
        if (a0 >= 0) {
          ...
          for (auto const& neighbor : AtomNeighbors(obj2, a0)) {
            ...
            if (toDo2_base[a1]) {
              ...
              stk[0] = a1;
              UtilZeroMem(atom, sizeof(int) * I->Table.size());
              atom2_base[a1] = 1; /* create selection for this atom alone as
                                     fragment base atom */
              comp2_base[a1] = 1;
              name = pymol::string_format("%s%1d", fragPref, nFrag + 1);
              SelectorEmbedSelection(G, atom, name, nullptr, false, -1);
              atom2_base[a1] = 0;
              c = SelectorWalkTreeDepth(G, atom2_base, comp2_base, toDo2_base,
                  &stk, stkDepth, obj2, sele1, sele2, sele3, sele4, &extraStk,
                  &curWalk);
              if (c) {
                nFrag++;
                name = pymol::string_format("%s%1d", pref, nFrag);
        ...
        if (a0 >= 0) {
          ...
          for (auto const& neighbor : AtomNeighbors(obj3, a0)) {
            ...
            if (toDo3_base[a1]) {
              ...
              stk[0] = a1;
              UtilZeroMem(atom, sizeof(int) * I->Table.size());
              atom3_base[a1] = 1; /* create selection for this atom alone as
                                     fragment base atom */
              comp3_base[a1] = 1;
              name = pymol::string_format("%s%1d", fragPref, nFrag + 1);
              SelectorEmbedSelection(G, atom, name, nullptr, false, -1);
              atom3_base[a1] = 0;
              c = SelectorWalkTreeDepth(G, atom3_base, comp3_base, toDo3_base,
                  &stk, stkDepth, obj3, sele1, sele2, sele3, sele4, &extraStk,
                  &curWalk);
              if (c) {
                nFrag++;
                name = pymol::string_format("%s%1d", pref, nFrag);
        ...
        if (a0 >= 0) {
          ...
          for (auto const& neighbor : AtomNeighbors(obj4, a0)) {
            ...
            if (toDo4_base[a1]) {
              ...
              stk[0] = a1;
              UtilZeroMem(atom, sizeof(int) * I->Table.size());
              atom4_base[a1] = 1; /* create selection for this atom alone as
                                     fragment base atom */
              comp4_base[a1] = 1;
              name = pymol::string_format("%s%1d", fragPref, nFrag + 1);
              SelectorEmbedSelection(G, atom, name, nullptr, false, -1);
              atom4_base[a1] = 0;
              c = SelectorWalkTreeDepth(G, atom4_base, comp4_base, toDo4_base,
                  &stk, stkDepth, obj4, sele1, sele2, sele3, sele4, &extraStk,
                  &curWalk);
              if (c) {
                nFrag++;
                name = pymol::string_format("%s%1d", pref, nFrag);
      ...
      if (minWalk.frag) { /* create the linking selection if one exists */
        link_sele = pymol::string_format(
            "%s%d|?pk1|?pk2|?pk3|?pk4", pref, minWalk.frag);
      }
      VLAFreeP(extraStk);
    }
...
/*========================================================================*/
int SelectorMapMaskVDW(
    PyMOLGlobals* G, int sele1, ObjectMapState* oMap, float buffer, int state)
{
  CSelector* I = G->Selector;
  float* v2;
  int n1;
    ...
    float resolution)
{
...

  {
    ...
    /* a gaussian_resolution of 2.0 is considered perfect ? Hmm...where is this
     * from??? */
  }
    ...
    float cutoff, int state, int neutral, int shift, float shift_power)
{
  ...
  " %s: Total charge is %0.3f for %d points (%d atoms).\n", __func__,
      tot_charge, n_point, n_at ENDFB(G);
...
/*========================================================================*/
int SelectorAssignAtomTypes(
    PyMOLGlobals* G, int sele, int state, int quiet, int format)
{
#ifndef NO_MMLIBS
  CSelector* I = G->Selector;
  int ok = true;
  ...
  for (SeleAtomIterator iter(G, sele); iter.next();) {
    ...
    LexAssign(G, iter.getAtomInfo()->textType, getMOL2Type(obj, iter.getAtm()));
  }
  return 1;
#endif
}
...
PyObject* SelectorGetCoordsAsNumPy(PyMOLGlobals* G, int sele, int state)
{
  ...
  for (i = 0, iter.reset(); iter.next(); i++) {
    ...
    if (mat_cs != iter.cs) {
      ...
      matrix_ptr = ObjectGetTotalMatrix(iter.obj, state, false, matrix)
                       ? matrix
                       : nullptr;
      mat_cs = iter.cs;
    }
 ...
 */
pymol::Result<> SelectorLoadCoords(
    PyMOLGlobals* G, PyObject* coords, int sele, int state)
{
#ifdef _PYMOL_NOPY
    ...
    int sta0, int sta1, int matchmaker, int quiet)
{
  ...
  if (c0 < 1 || c1 < 1)
    ...
    for (a = 0; a < c1; a++) { /* iterate over source atoms */
      ...
      switch (matchmaker) {
      case 0:
        /* simply assume that atoms are stored in PyMOL in the identical order,
         * one for one */
        if (b < c0) {
          i0 = vla0[b];
          at0 = I->Table[i0].atom;
...
int SelectorCreateObjectMolecule(PyMOLGlobals* G, SelectorID_t sele,
    const char* name, int target, int source, int discrete, int zoom, int quiet,
    int singletons, int copy_properties)
{
  ...
  std::function<void(int)> const body = [&](int const source) {
    ...
    for (a = cNDummyModels; a < I->Obj.size();
        a++) { /* find bonds wholly contained in the selection */
      obj = I->Obj[a];
      ii1 = obj->Bond;
        ...
        if ((b1 >= 0) && (b2 >= 0)) {
          if ((I->Table[b1].index >= 0) && (I->Table[b2].index >= 0)) {
            BondType* dst_bond = bond.check(nBond);
            {
              ...
              dst_bond->index[0] =
                  I->Table[b1].index; /* store what will be the new index */
              dst_bond->index[1] = I->Table[b2].index;
              /*            printf("Selector-DEBUG %d
    ...
    ObjectMoleculeMerge(targ, std::move(atInfo), cs, false, cAIC_AllMask,
        true); /* will free atInfo */
    ...
    for (StateIterator iter(G, nullptr, source, nCSet); iter.next();) {
      d = iter.state;
      {
        ...
        c = 0;
        cs2->setNIndex(nAtom);
        for (a = cNDummyAtoms; a < I->Table.size();
            a++) /* any selected atoms in this state? */
          if (I->Table[a].index >= 0) {
            at = I->Table[a].atom;
            obj = I->Obj[I->Table[a].model];
            cs1 = nullptr;
            ...
            if (cs1) {
              if ((!cs2->Name[0]) &&
                  (cs1->Name[0])) /* copy the molecule name (if any) */
                strcpy(cs2->Name, cs1->Name);

              if (CoordSetGetAtomVertex(cs1, at, cs2->coordPtr(c))) {
                a2 = cs->IdxToAtm[I->Table[a].index]; /* actual merged atom
                                                         index */
                cs2->IdxToAtm[c] = a2;
                c++;
              }
 ...
 */
SelectorID_t SelectorIndexByName(
    PyMOLGlobals* G, const char* sname, int ignore_case)
{
  auto I = G->SelectorMgr;
  ...
  if (sname) {
    ...
    if (sname[0] != '_') { /* don't do checking on internal selections */
      const char* best;
      best = ExecutiveFindBestNameMatch(
          G, sname); /* suppress spurious matches
...
{
  auto& Info = G->SelectorMgr->Info;
  auto it = SelectGetInfoIter(
      G, sele, 999, SettingGetGlobal_b(G, cSetting_ignore_case));
...
pymol::Result<int> SelectorGetTmp2Result(
    PyMOLGlobals* G, const char* input, char* store, bool quiet)
{
  ...
  if (input[0] && !((input[0] == '\'') && (input[1] == '\'') && (!input[2]))) {
    ...
    if (!is_selection)
      while (*p) {
        ...
        if (!ExecutiveValidName(G, word)) { /* don't recognize the name? */
          if (!ExecutiveValidNamePattern(
                  G, word)) {    /* don't recognize this as a pattern? */
    ...
    if (is_selection) { /* incur the computational expense of
      ...
      return res;
    } else { /* otherwise, just parse the input as a space-separated list of
                names */
      /* not a selection */
      strcpy(store, input);
    }
...
pymol::Result<int> SelectorGetTmpResult(
    PyMOLGlobals* G, const char* input, char* store, bool quiet)
{
  store[0] = 0;
    ...
    int exec_managed)
{
  ...
  // already exist?
  auto it = SelectGetInfoIter(
      G, name.c_str(), 999, SettingGetGlobal_b(G, cSetting_ignore_case));
  if (it != IM->Info.end()) {
...
/*========================================================================*/
static sele_array_t SelectorSelectFromTagDict(
    PyMOLGlobals* G, const std::unordered_map<int, int>& id2tag)
{
  CSelector* I = G->Selector;
  sele_array_t result{};

  SelectorUpdateTable(G, cSelectorUpdateTableAllStates,
      -1); /* for now, update the entire table */
  {
    sele_array_calloc(result, I->Table.size());
    if (result) {
      for (int a = cNDummyAtoms; a < I->Table.size(); a++) {
...
static SelectorCreateResult_t _SelectorCreate(PyMOLGlobals* G,
    pymol::zstring_view sname, const char* sele, ObjectMolecule** obj,
    int quiet, Multipick* mp, CSeqRow* rowVLA, int nRow, int** obj_idx,
    int* n_idx, int n_obj, const std::unordered_map<int, int>* id2tag,
    int executive_manage, int state, SelectorID_t domain)
{
  sele_array_t atom{};
  std::string name;
  int c = 0;
  ...
  c = SelectorEmbedSelection(
      G, atom.get(), sname, embed_obj, false, executive_manage);
  SelectorClean(G);
...
SelectorCreateResult_t SelectorCreateFromTagDict(PyMOLGlobals* G,
    const char* sname, const std::unordered_map<int, int>& id2tag,
    int exec_managed)
{
  return _SelectorCreate(G, sname, nullptr, nullptr, true, nullptr, nullptr, 0,
      nullptr, nullptr, 0, &id2tag, exec_managed, -1, -1);
}

SelectorCreateResult_t SelectorCreateEmpty(
    PyMOLGlobals* G, const char* name, int exec_managed)
{
  return _SelectorCreate(G, name, "none", nullptr, 1, nullptr, nullptr, 0,
      nullptr, 0, 0, nullptr, exec_managed, -1, -1);
}

SelectorCreateResult_t SelectorCreateSimple(
    PyMOLGlobals* G, const char* name, const char* sele)
{
  return _SelectorCreate(G, name, sele, nullptr, 1, nullptr, nullptr, 0,
      nullptr, 0, 0, nullptr, -1, -1, -1);
}

SelectorCreateResult_t SelectorCreateFromObjectIndices(PyMOLGlobals* G,
    const char* sname, ObjectMolecule* obj, int* idx, int n_idx)
{
  return _SelectorCreate(G, sname, nullptr, &obj, true, nullptr, nullptr, 0,
      &idx, &n_idx, -1, nullptr, -1, -1, -1);
  /* n_obj = -1 disables numbered tags */
}

SelectorCreateResult_t SelectorCreateOrderedFromObjectIndices(PyMOLGlobals* G,
    const char* sname, ObjectMolecule* obj, int* idx, int n_idx)
{
  return _SelectorCreate(G, sname, nullptr, &obj, true, nullptr, nullptr, 0,
      &idx, &n_idx, 0, nullptr, -1, -1, -1);
  /* assigned numbered tags */
}

SelectorCreateResult_t SelectorCreate(PyMOLGlobals* G, const char* sname,
    const char* sele, ObjectMolecule* obj, int quiet, Multipick* mp)
{
  return _SelectorCreate(G, sname, sele, &obj, quiet, mp, nullptr, 0, nullptr,
      0, 0, nullptr, -1, -1, -1);
}

SelectorCreateResult_t SelectorCreateWithStateDomain(PyMOLGlobals* G,
    const char* sname, const char* sele, ObjectMolecule* obj, int quiet,
    Multipick* mp, int state, const char* domain)
{
  ...
  return _SelectorCreate(G, sname, sele, &obj, quiet, mp, nullptr, 0, nullptr,
      0, 0, nullptr, -1, state, domain_sele);
}
    ...
    PyMOLGlobals* G, ObjectMolecule* obj, int req_state, bool no_dummies)
{
  ...
  switch (req_state) {
  case cSelectorUpdateTableAllStates:
    I->SeleBaseOffsetsValid =
        true; /* all states -> all atoms -> offsets valid */
    break;
  default:
    I->SeleBaseOffsetsValid =
        false; /* not including all atoms, so atom-based offsets are invalid */
    break;
  }
 ...
 * @pre SelectorUpdateTableSingleObject(cSelectorUpdateTableAllStates,
 * no_dummies=false) was called
 */
static sele_array_t SelectorGetSeleArrayForAtomIndices(CSelector* I,
    ObjectMolecule* obj, const int* idx, int n_idx, bool numbered_tags)
{
...
int SelectorUpdateTableImpl(
    PyMOLGlobals* G, CSelector* I, int req_state, SelectorID_t domain)
{
  int a = 0;
  ov_size c = 0;
  int modelCnt;
                    ...
                    if (base[1].sele[a]) {
                      ...
                      if (cs) {
                        ...
                        if (idx >= 0) {
                          ...
                          for (const auto j : MapEIter(*map, v2, false)) {
                            if ((base[0].sele[j]) &&
                                (!base[1].sele[j])) { /*exclude current
                                                         selection */
                              if (within3f(Vertex.data() + 3 * j, v2,
                                      dist + /* eliminate atoms w/o gap */
...
static int SelectorSelect0(PyMOLGlobals* G, EvalElem* passed_base)
{
...

  {
    ...
    case SELE_ACCz:
      for (a = cNDummyAtoms; a < I->Table.size(); a++)
        base[0].sele[a] =
            I->Obj[I->Table[a].model]->AtomInfo[I->Table[a].atom].hb_acceptor;
      break;
    case SELE_HBDs:
    case SELE_DONz:
      for (a = cNDummyAtoms; a < I->Table.size(); a++)
        base[0].sele[a] =
            I->Obj[I->Table[a].model]->AtomInfo[I->Table[a].atom].hb_donor;
      break;
    }
    break;
  case SELE_NONz:
  ...
  case SELE_BNDz:
    for (a = cNDummyAtoms; a < I->Table.size(); a++)
      base[0].sele[a] =
          I->Obj[I->Table[a].model]->AtomInfo[I->Table[a].atom].bonded;
    break;
  case SELE_HETz:
    for (a = cNDummyAtoms; a < I->Table.size(); a++)
      base[0].sele[a] =
          I->Obj[I->Table[a].model]->AtomInfo[I->Table[a].atom].hetatm;
    break;
  case SELE_HYDz:
    for (a = cNDummyAtoms; a < I->Table.size(); a++)
      base[0].sele[a] =
          I->Obj[I->Table[a].model]->AtomInfo[I->Table[a].atom].isHydrogen();
    break;
  case SELE_METz:
    for (a = cNDummyAtoms; a < I->Table.size(); a++) {
      base[0].sele[a] =
          I->Obj[I->Table[a].model]->AtomInfo[I->Table[a].atom].isMetal();
    }
    break;
  case SELE_BB_z:
  case SELE_SC_z: {
  ...
  case SELE_FXDz:
    for (a = cNDummyAtoms; a < I->Table.size(); a++)
      base[0].sele[a] =
          I->Obj[I->Table[a].model]->AtomInfo[I->Table[a].atom].flags &
          cAtomFlag_fix;
    break;
  case SELE_RSTz:
    for (a = cNDummyAtoms; a < I->Table.size(); a++)
  ...
  case SELE_PTDz:
    for (a = cNDummyAtoms; a < I->Table.size(); a++)
      base[0].sele[a] =
          I->Obj[I->Table[a].model]->AtomInfo[I->Table[a].atom].protekted !=
          cAtomProtected_off;
    break;
  case SELE_MSKz:
    for (a = cNDummyAtoms; a < I->Table.size(); a++)
      base[0].sele[a] =
          I->Obj[I->Table[a].model]->AtomInfo[I->Table[a].atom].masked;
    break;
  case SELE_ORGz:
    for (a = cNDummyAtoms; a < I->Table.size(); a++)
      base[0].sele[a] =
  ...
  case SELE_GIDz:
    for (a = cNDummyAtoms; a < I->Table.size(); a++)
      base[0].sele[a] =
          bool(I->Obj[I->Table[a].model]->AtomInfo[I->Table[a].atom].flags &
               cAtomFlag_guide);
    break;
...
/*========================================================================*/
static pymol::Result<> SelectorSelect1(
    PyMOLGlobals* G, EvalElem* base, int quiet)
{
  CSelector* I = G->Selector;
  auto IM = I->mgr;
  ...
  case SELE_PEPs:
    if (base[1].text()[0]) {
      ...
      for (a = cNDummyAtoms; a < I_NAtom; a++) {
        ...
        if (!AtomInfoSameResidueP(
                G, ai0, last_ai0)) { /* new starting residue */
          ...
          for (b = a; b < I_NAtom; b++) {
            ...
            if (!AtomInfoSameResidueP(G, ai1, last_ai1)) {
              if (*ch != '-') { /* if not skipping this residue */
                if (!((*ch == '+') ||
                        (SeekerGetAbbr(G, LexStr(G, ai1->resn), 'O', 0) ==
                            *ch))) { /* if a mismatch */
                  break;
                }
              }
          ...
          if (match_found) {
            ...
            for (b = a; b < I_NAtom; b++) {
              ...
              if (!AtomInfoSameResidueP(G, ai1, last_ai1)) {
                if (*ch != '-') { /* if not skipping this residue */
                  if ((*ch == '+') || (SeekerGetAbbr(G, LexStr(G, ai1->resn),
                                           'O', 0) == *ch)) { /* if matched */
                    int d;
                    for (d = b; d < I_NAtom; d++) {
  ...
  case SELE_IDXs: {
    ...
    if ((matcher = WordMatcherNew(G, base[1].text(), &options, true))) {
      ...
      for (a = cNDummyAtoms; a < I_NAtom; a++) {
        auto& table_a = I->Table[a];
        if ((*base_0_sele_a =
                    WordMatcherMatchInteger(matcher, table_a.atom + 1)))
          c++;
        base_0_sele_a++;
      }
  ...
  case SELE_ID_s: {
    ...
    if ((matcher = WordMatcherNew(G, base[1].text(), &options, true))) {
      ...
      for (a = cNDummyAtoms; a < I_NAtom; a++) {
        auto& table_a = I->Table[a];
        if ((*base_0_sele_a = WordMatcherMatchInteger(
                 matcher, I->Obj[table_a.model]->AtomInfo[table_a.atom].id)))
          c++;
        base_0_sele_a++;
      }
      WordMatcherFree(matcher);
  ...
  case SELE_RNKs: {
    ...
    if ((matcher = WordMatcherNew(G, base[1].text(), &options, true))) {
      ...
      for (a = cNDummyAtoms; a < I_NAtom; a++) {
        auto& table_a = I->Table[a];
        if ((*base_0_sele_a = WordMatcherMatchInteger(
                 matcher, I->Obj[table_a.model]->AtomInfo[table_a.atom].rank)))
          c++;
        base_0_sele_a++;
      }
      WordMatcherFree(matcher);
  ...
  case SELE_NAMs: {
    ...
    const char* atom_name_wildcard =
        SettingGetGlobal_s(G, cSetting_atom_name_wildcard);

    if (!atom_name_wildcard[0])
      atom_name_wildcard = wildcard;

    WordMatchOptionsConfigAlphaList(
        &options, atom_name_wildcard[0], ignore_case);
    ...
    for (a = cNDummyAtoms; a < I_NAtom; a++) {
      ...
      if (obj != last_obj) {
        ...
        /* allow objects to have their own atom_name_wildcards...this is a
           tricky workaround for handling nucleic acid structures that use "*"
           in atom names */

        const char* atom_name_wildcard = SettingGet_s(
            G, obj->Setting.get(), nullptr, cSetting_atom_name_wildcard);
        ...
        if (options.wildcard != atom_name_wildcard[0]) {
          ...
          if (!matcher)
            WordPrimeCommaMatch(
                G, &base[1].m_text[0] /* replace '+' with ',' */);
        }
        last_obj = obj;
      }
      ...
      if (matcher)
        hit_flag = WordMatcherMatchAlpha(matcher, name);
      else
        hit_flag =
            (WordMatchCommaExact(G, base[1].text(), name, ignore_case) < 0);
...
#endif
        if ((*base_0_sele_a =
                    WordMatcherMatchAlpha(matcher, LexStr(G, ai->textType))))
          c++;
        base_0_sele_a++;
      }
      WordMatcherFree(matcher);
  ...
  case SELE_ELEs: {
    ...
    if ((matcher = WordMatcherNew(G, base[1].text(), &options, true))) {
      ...
      for (a = cNDummyAtoms; a < I_NAtom; a++) {
        auto& table_a = I->Table[a];
        if ((*base_0_sele_a = WordMatcherMatchAlpha(
                 matcher, I->Obj[table_a.model]->AtomInfo[table_a.atom].elem)))
          c++;
        base_0_sele_a++;
      }
      WordMatcherFree(matcher);
...
#ifndef NO_MMLIBS
#endif
        const char* mmstereotype = AtomInfoGetStereoAsStr(
            I->Obj[table_a.model]->AtomInfo + table_a.atom);
        if ((*base_0_sele_a = WordMatcherMatchAlpha(matcher, mmstereotype)))
          c++;
        base_0_sele_a++;
      }
      WordMatcherFree(matcher);
  ...
  case SELE_COLs:
    ...
    for (a = cNDummyAtoms; a < I_NAtom; a++) {
      base[0].sele[a] = false;
      if (I->Obj[I->Table[a].model]->AtomInfo[I->Table[a].atom].color ==
          col_idx) {
        base[0].sele[a] = true;
        c++;
      }
  ...
  case SELE_RCLs:
    // setting index
    index = (base->code == SELE_CCLs) ? cSetting_cartoon_color
                                      : cSetting_ribbon_color;
    col_idx = ColorGetIndex(G, base[1].text());
    for (a = cNDummyAtoms; a < I_NAtom; a++) {
      base[0].sele[a] = false;
      {
        AtomInfoType* ai =
            I->Obj[I->Table[a].model]->AtomInfo + I->Table[a].atom;
        int value;
  ...
  case SELE_LABs: {
    ...
    if ((matcher = WordMatcherNew(G, base[1].text(), &options, true))) {
      ...
      for (a = cNDummyAtoms; a < I_NAtom; a++) {
        auto& table_a = I->Table[a];
        if ((*base_0_sele_a = WordMatcherMatchAlpha(matcher,
                 LexStr(G, *reinterpret_cast<decltype(AtomInfoType::chain)*>(
                               ((char*) (I->Obj[table_a.model]->AtomInfo +
                                         table_a.atom)) +
                               offset)))))
          c++;
        base_0_sele_a++;
  ...
  case SELE_SSTs: {
    ...
    if ((matcher = WordMatcherNew(G, base[1].text(), &options, true))) {
      ...
      for (a = cNDummyAtoms; a < I_NAtom; a++) {
        auto& table_a = I->Table[a];
        if ((*base_0_sele_a = WordMatcherMatchAlpha(matcher,
                 I->Obj[table_a.model]->AtomInfo[table_a.atom].ssType)))
          c++;
        base_0_sele_a++;
      }
      WordMatcherFree(matcher);
  ...
  case SELE_ALTs: {
    ...
    if ((matcher = WordMatcherNew(G, base[1].text(), &options, true))) {
      ...
      for (a = cNDummyAtoms; a < I_NAtom; a++) {
        auto& table_a = I->Table[a];
        if ((*base_0_sele_a = WordMatcherMatchAlpha(
                 matcher, I->Obj[table_a.model]->AtomInfo[table_a.atom].alt)))
          c++;
        base_0_sele_a++;
      }
      WordMatcherFree(matcher);
  ...
  case SELE_NTYs: {
    ...
    if ((matcher = WordMatcherNew(G, base[1].text(), &options, true))) {
      ...
      for (a = cNDummyAtoms; a < I_NAtom; a++) {
        auto& table_a = I->Table[a];
        if ((*base_0_sele_a = WordMatcherMatchInteger(matcher,
                 I->Obj[table_a.model]->AtomInfo[table_a.atom].customType)))
          c++;
        base_0_sele_a++;
      }
      WordMatcherFree(matcher);
  ...
  case SELE_RSNs: {
    ...
    if ((matcher = WordMatcherNew(G, base[1].text(), &options, true))) {
      ...
      for (a = cNDummyAtoms; a < I_NAtom; a++) {
        ...
        if ((*base_0_sele_a = WordMatcherMatchAlpha(matcher, LexStr(G, resn))))
          c++;
        base_0_sele_a++;
      }
      WordMatcherFree(matcher);
  ...
  case SELE_SELs: {
    ...
    if ((matcher = WordMatcherNew(G, word, &options, false))) {
      ...
      for (a = 0; a < I_NAtom;
          a++) /* zero out first before iterating through selections */
        base[0].sele[a] = false;
      ...
      for (const auto& rec : I->mgr->Info) {
        ...
        if (WordMatcherMatchAlpha(matcher, rec.name.c_str())) {
          if (!enabled_only || activeselename == rec.name) {
            for (a = cNDummyAtoms; a < I_NAtom; a++) {
              s = I->Obj[I->Table[a].model]
                      ->AtomInfo[I->Table[a].atom]
                      .selEntry;
              while (s) {
...

      {
        int group_list_id;
        if ((group_list_id =
                    ExecutiveGetExpandedGroupListFromPattern(G, word))) {
          ...
          for (a = cNDummyAtoms; a < I_NAtom; a++) {
            if (last_obj != I->Obj[I->Table[a].model]) {
              ...
              last_was_member =
                  ExecutiveCheckGroupMembership(G, group_list_id, last_obj);
            }
      ...
      if ((matcher = WordMatcherNew(G, base[1].text(), &options, false))) {
        ...
        for (a = cNDummyAtoms; a < I_NAtom; a++) {
          ...
          if (obj != last_obj) {
            ...
            obj_matches =
                WordMatcherMatchAlpha(matcher, I->Obj[table_a.model]->Name);
            last_obj = obj;
          }
          if (obj_matches) {
...
static int SelectorLogic1(PyMOLGlobals* G, EvalElem* inp_base, int state)
{
  ...
  case SELE_RING: {
    std::vector<bool> selemask(
        base[0].sele_data(), base[0].sele_data() + n_atom);
  ...
  case SELE_CAS1: {
    ...
    for (a = cNDummyAtoms; a < n_atom; a++) {
      ...
      if ((tag = base_0_sele[a]) &&
          ((a >= break_atom) || (base_0_sele[a] != last_tag))) {
                      ...
                      if (cs) {
                        ...
                        if (sym) {
                          ...
                          if (idx >= 0) {
                            ...
                            transform33f3f(sym->Crystal.realToFrac(),
                                cs->coordPtr(idx), probe);
...
static int SelectorLogic2(PyMOLGlobals* G, EvalElem* base)
{
  ...
  case SELE_IOR2: {
    ...
    for (a = 0; a < n_atom; a++) {
      if (((*base_0_sele_a) =
                  (((*base_0_sele_a) > (*base_2_sele_a)) ? (*base_0_sele_a)
                                                         : (*base_2_sele_a)))) {
        /* use higher tag */
        c++;
      }
            ...
            if (at1->resv == at2->resv)
              if (WordMatchExact(G, at1->chain, at2->chain, ignore_case_chain))
                if (WordMatchExact(G, at1->name, at2->name, ignore_case))
                  if (WordMatchExact(
                          G, at1->inscode, at2->inscode, ignore_case))
                    if (WordMatchExact(G, at1->resn, at2->resn, ignore_case))
                      if (WordMatchExact(
                              G, at1->segi, at2->segi, ignore_case_chain)) {
                        *base_0_sele_a = tag;
                        break;
                      }
          }
      ...
      if (quote_start && (active_quote == *p)) { /* eliminate quotes... */
        ...
        if (p == st) { /* at start => real quote */
          ...
          active_quote = *p;
                   ...
                   (*(p - 1) == ',')) { /* after separator => real quote */
          quote_start = q;
          active_quote = *p;
        }
      }
...
/*========================================================================*/
pymol::Result<sele_array_t> SelectorEvaluate(
    PyMOLGlobals* G, std::vector<std::string>& word, int state, int quiet)
{
      ...
      if (valueFlag > 0) { /* standard operand */
        ...
        if (code) {
          ...
          if ((a = std::count(word[c].begin(), word[c].end(),
            ...
            const int macrocodes[] = {
                SELE_SELs, SELE_SEGs, SELE_CHNs, SELE_RSNs, SELE_NAMs};
            ...
            for (b = 0; q && *q; a--) {
              ...
              if (codes[0] == SELE_RSNs || codes[0] == SELE_NAMs) {
                ...
                if (backtick) {
                  ...
                  values[1] = backtick + 1;
                  *backtick = '\0';
                } else if (codes[0] == SELE_RSNs && values[0][0] >= '0' &&
                           values[0][0] <= '9') {
                  // numeric -> resi
                  codes[0] = SELE_RSIs;
                }
            ...
            if (!b)
              STACK_PUSH_OPERATION(SELE_ALLz);
                     ...
                     std::string::npos) { /* handle <object`index> syntax */
  ...
  if (ok) { /* this is the main operation loop */
    ...
    if (level >= 0)
      while (ok) { /* loop until all ops at all levels have been tried */
        ...
        depth = 1;
        opFlag = true;
        while (ok && opFlag) { /* loop through all entries looking for ops at
                                  the current level */
          opFlag = false;
...
DistSet* SelectorGetDistSet(PyMOLGlobals* G, DistSet* ds, int sele1, int state1,
    int sele2, int state2, int mode, float cutoff, float* result)
{
  CSelector* I = G->Selector;
  std::vector<int> vla;
  int c;
  ...
  *result = 0.0;
  ...
  if ((mode == 1) || (mode == 2) ||
      (mode == 3)) { /* fill in all the neighbor tables */
    int max_n_atom = I->Table.size();
    lastObj = nullptr;
    for (a = cNDummyAtoms; a < I->Table.size(); a++) {
      ...
      obj = I->Obj[I->Table[a].model]; /* -- JV -- quick way to get an object
                                          from an atom */
      s = obj->AtomInfo[at]
  ...
  if (mode == 4) {
    ...
    /* this creates an interleaved list of ints for mapping ids to states within
     * a given neighborhood */
    vla = SelectorGetInterstateVector(
        G, sele1, state1, sele2, state2, cutoff_map);
    c = vla.size() / 2;
  }
            ...
            if (dist < cutoff) {
              ...
              if (exclusion && (obj1 == obj2)) {
                a_keeper = !SelectorCheckNeighbors(
                    G, exclusion, obj1, at1, at2, zero, scratch);
              } else if (bonds_only) {
                a_keeper =
                    SelectorCheckNeighbors(G, 1, obj1, at1, at2, zero, scratch);
              }
              if (a_keeper && (mode == 2)) {
                // We need to check:
                // situation 1:                      ai1 == donor and ai2 ==
                // acceptor situation 2 (if not situation 1): ai1 == acceptor
                // and ai2 == donor
...
DistSet* SelectorGetAngleSet(PyMOLGlobals* G, DistSet* ds, int sele1,
    int state1, int sele2, int state2, int sele3, int state3, int mode,
    float* angle_sum, int* angle_cnt)
{
  CSelector* I = G->Selector;
  int nv = 0;
  std::vector<bool> coverage;
...

  {
    ...
    for (a = cNDummyAtoms; a < I->Table.size(); a++) {
      ...
      obj = I->Obj[I->Table[a].model];
      s = obj->AtomInfo[at].selEntry;
      if (SelectorIsMember(G, s, sele1) && SelectorIsMember(G, s, sele3))
        coverage[a] = true;
    }
  }
                  ...
                  if (state2 < obj2->NCSet) {
                    ...
                    if (cs2) {
                      ...
                      if (idx2 >= 0) {
                        ...
                        bonded12 =
                            ObjectMoleculeAreAtomsBonded2(obj1, at1, obj2, at2);
                        ...
                        for (i3 = 0; i3 < n3; i3++) {
                          ...
                          if ((a1 != a2 || state1 != state2) &&
                              (a2 != a3 || state2 != state3) &&
                              (a1 != a3 || state1 != state3)) {
                            if (!(coverage[a1] && coverage[a3]) || (a1 < a3) ||
                                (state1 !=
                                    state3)) { /* eliminate alternate-order
                                                  duplicates */
                              ...
                              if (state3 < obj3->NCSet) {
                                ...
                                if (cs3) {
                                  ...
                                  if (idx3 >= 0) {
                                    ...
                                    bonded23 = ObjectMoleculeAreAtomsBonded2(
                                        obj2, at2, obj3, at3);
                                    ...
                                    if (!mode || ((mode == 1) &&
                                      ...
                                      /* Insert DistInfo records for updating
                                       * distances */
                                      /* Init/Add the elem to the DistInfo list
                                       */
                                      ds->MeasureInfo.emplace_front();
                                      auto* atom1Info =
                                          &ds->MeasureInfo.front();

                                      // TH
                                      atom1Info->id[0] = AtomInfoCheckUniqueID(
                                          G, obj1->AtomInfo + at1);
                                      atom1Info->id[1] = AtomInfoCheckUniqueID(
                                          G, obj2->AtomInfo + at2);
                                      atom1Info->id[2] = AtomInfoCheckUniqueID(
                                          G, obj3->AtomInfo + at3);

                                      atom1Info->offset =
                                          nv; /* offset into this DSet's Coord
                                               */
                                      atom1Info->state[0] =
                                          state1; /* state1 of sel1 */
                                      atom1Info->state[1] = state2;
                                      ...
                                      *(vv0++) = 0.0F;
                                      *(vv0++) =
                                          0.0F; /* label x relative to v2 */
                                      *(vv0++) =
                                          0.0F; /* label y relative to v2 */
                                      *(vv0++) =
                                          0.0F; /* label z relative to v2 */
                                      nv += 5;
                                    }
                                  }
                                }
...
DistSet* SelectorGetDihedralSet(PyMOLGlobals* G, DistSet* ds, int sele1,
    int state1, int sele2, int state2, int sele3, int state3, int sele4,
    int state4, int mode, float* angle_sum, int* angle_cnt)
{
  CSelector* I = G->Selector;
  int nv = 0;
...

  {
    ...
    if (list1 && list2 && list3 && list4) {
      ...
      if (just_one_object && (just_one_atom[0] >= 0) &&
          (just_one_atom[1] >= 0) && (just_one_atom[2] >= 0) &&
          (just_one_atom[3] >= 0)) {
        /* optimal case */
                                            ...
                                            if (cs4) {
                                              ...
                                              if (idx4 >= 0) {
                                                ...
                                                if (!mode ||
                                                  ...
                                                  /* Insert DistInfo records for
                                                   * updating distances */
                                                  /* Init/Add the elem to the
                                                   * DistInfo list */
                                                  ds->MeasureInfo
                                                      .emplace_front();
                                                  auto* atom1Info =
                                                  ...
                                                  atom1Info->measureType =
                                                      cRepDihedral;

                                                  angle = get_dihedral3f(
                                                      v1, v2, v3, v4);
                                                  ...
                                                  VLACheck(
                                                      vv, float, (nv * 3) + 17);
                                                  vv0 = vv + (nv * 3);
                                                  ObjectMoleculeGetAtomTxfVertex(
                                                      obj1, state1, at1, vv0);
                                                  ObjectMoleculeGetAtomTxfVertex(
                                                      obj2, state2, at2,
                                                      vv0 + 3);
                                                  ...
                                                  *(vv0++) = (float) !bonded34;
                                                  *(vv0++) =
                                                      0.0F; /* label x relative
                                                               to v2+v3/2 */
                                                  *(vv0++) =
                                                      0.0F; /* label y relative
                                                               to v2+v3/2 */
                                                  *(vv0++) =
                                                      0.0F; /* label z relative
                                                               to v2+v3/2 */
                                                  nv += 6;
                                                }
                                              }
...
/* Definition of the selection language:
        ...
        <sele> = [(] [<not>] <prop> <val-range> [<qual> [<qual-range>] ] [)] {
   <SEL1> <sele> }
...
/* Selection processing, left to right by default, but with parenthesis for
   grouping stack based functional language processing each stack level has a
   full selection matrix logical binary operators (or,and) and negation
   SEL1ation solely on these matrices.
*/
