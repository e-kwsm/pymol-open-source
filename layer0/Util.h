...
void UtilNCopyToLower(
    char* dst, const char* src, ov_size n); /* up to N-1 chars */
...
int UtilSemiSortFloatIndexWithNBins(
    int n, int nbins, float* array, int* x, int forward);
...
typedef int UtilOrderFnGlobals(
    PyMOLGlobals* G, const void* array, int l, int r);
